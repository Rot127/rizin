...
RzILOpEffect *hex_il_op_sl2_deallocframe_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	// Declare: ut32 EA;
...
RzILOpEffect *hex_il_op_sl2_jumpr31_part0(HexInsnPktBundle *bundle) {
	// READ
	const char *lr_assoc = ALIAS2REG(HEX_REG_ALIAS_LR);
	RzILOpPure *lr = VARG(lr_assoc);
...
RzILOpEffect *hex_il_op_sl2_jumpr31_f_part0(HexInsnPktBundle *bundle) {
	// READ
...
RzILOpEffect *hex_il_op_sl2_jumpr31_fnew_part0(HexInsnPktBundle *bundle) {
	// READ
...
RzILOpEffect *hex_il_op_sl2_jumpr31_t_part0(HexInsnPktBundle *bundle) {
	// READ
	const char *P0P0_assoc = ISA2REG(hi, '0', false);
	RzILOpPure *P0P0 = VARG(P0P0_assoc);
	RzILOpPure *const_pos1 = UN(32, 0x1);
...
RzILOpEffect *hex_il_op_sl2_jumpr31_tnew_part0(HexInsnPktBundle *bundle) {
	// READ
	const char *P0P0_tmp_assoc = ISA2REG(hi, '0', true);
	RzILOpPure *P0P0 = VARG(P0P0_tmp_assoc);
	RzILOpPure *const_pos1 = UN(32, 0x1);
...
RzILOpEffect *hex_il_op_sl2_loadrb_io_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 EA;
...
RzILOpEffect *hex_il_op_sl2_loadrd_sp_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 EA;
	const char *sp_assoc = ALIAS2REG(HEX_REG_ALIAS_SP);
	RzILOpPure *sp = VARG(sp_assoc);
...
RzILOpEffect *hex_il_op_sl2_loadrh_io_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 EA;
	const char *Rs_assoc = ISA2REG(hi, 's', false);
	RzILOpPure *Rs = VARG(Rs_assoc);
...
RzILOpEffect *hex_il_op_sl2_loadri_sp_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 EA;
	const char *sp_assoc = ALIAS2REG(HEX_REG_ALIAS_SP);
	RzILOpPure *sp = VARG(sp_assoc);
...
RzILOpEffect *hex_il_op_sl2_loadruh_io_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 EA;
	const char *Rs_assoc = ISA2REG(hi, 's', false);
	RzILOpPure *Rs = VARG(Rs_assoc);
...
RzILOpEffect *hex_il_op_sl2_return_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	// Declare: ut32 EA;
	const char *fp_assoc = ALIAS2REG(HEX_REG_ALIAS_FP);
...
RzILOpEffect *hex_il_op_sl2_return_f_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	// Declare: ut32 EA;
	const char *fp_assoc = ALIAS2REG(HEX_REG_ALIAS_FP);
...
RzILOpEffect *hex_il_op_sl2_return_fnew_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	// Declare: ut32 EA;
	const char *fp_assoc = ALIAS2REG(HEX_REG_ALIAS_FP);
...
RzILOpEffect *hex_il_op_sl2_return_t_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	// Declare: ut32 EA;
	const char *fp_assoc = ALIAS2REG(HEX_REG_ALIAS_FP);
...
RzILOpEffect *hex_il_op_sl2_return_tnew_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	// Declare: ut32 EA;
	const char *fp_assoc = ALIAS2REG(HEX_REG_ALIAS_FP);
