...
RzILOpEffect *hex_il_op_dep_a2_addsat_part0(HexInsnPktBundle *bundle) {
	// READ
...
RzILOpEffect *hex_il_op_dep_a2_subsat_part0(HexInsnPktBundle *bundle) {
	// READ
	const char *Rd_assoc = ISA2REG(hi, 'd', false);
	RzILOpPure *const_pos32 = UN(32, 0x20);
	RzILOpPure *const_pos0 = UN(32, 0x0);
...
RzILOpEffect *hex_il_op_dep_s2_packhl_part0(HexInsnPktBundle *bundle) {
	// READ
