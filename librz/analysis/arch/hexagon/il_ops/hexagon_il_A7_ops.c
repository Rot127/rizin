...
RzILOpEffect *hex_il_op_a7_clip(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_3 = LET("const_pos1", DUP(const_pos1), LET("u", u, SHIFTL0(VARLP("const_pos1"), VARLP("u"))));
...
RzILOpEffect *hex_il_op_a7_vclip(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_35 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), SHIFTL0(VARLP("const_pos0x0ffffffffLL"), op_MUL_34));
	RzILOpPure *op_NOT_36 = LOGNOT(op_LSHIFT_35);
	RzILOpPure *op_AND_37 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_36);
	RzILOpPure *op_AND_38 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(VARL("tmp"), VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_LSHIFT_44 = LET("const_pos1", DUP(const_pos1), LET("u", u, SHIFTL0(VARLP("const_pos1"), VARLP("u"))));
	RzILOpPure *op_SUB_45 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_44, VARLP("const_pos1")));
	RzILOpPure *op_LSHIFT_47 = LET("const_pos1", DUP(const_pos1), LET("u", u, SHIFTL0(VARLP("const_pos1"), VARLP("u"))));
	RzILOpPure *op_NEG_48 = NEG(op_LSHIFT_47);
	RzILOpPure *op_MUL_50 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_51 = SHIFTR0(DUP(Rss), op_MUL_50);
	RzILOpPure *op_AND_52 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_51, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_AND_58 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_57, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_AND_82 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(VARL("tmp"), VARLP("const_pos0x0ffffffffLL")));
