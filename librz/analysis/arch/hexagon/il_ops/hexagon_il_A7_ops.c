...
RzILOpEffect *hex_il_op_a7_clip_part0(HexInsnPktBundle *bundle) {
	// READ
...
RzILOpEffect *hex_il_op_a7_croundd_ri_part0(HexInsnPktBundle *bundle) {
	NOT_IMPLEMENTED;
	const HexInsn *hi = bundle->insn;
	NOT_IMPLEMENTED;
}

RzILOpEffect *hex_il_op_a7_croundd_rr_part0(HexInsnPktBundle *bundle) {
	NOT_IMPLEMENTED;
	const HexInsn *hi = bundle->insn;
	NOT_IMPLEMENTED;
}

RzILOpEffect *hex_il_op_a7_vclip_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut64 tmp;
	RzILOpPure *const_pos1 = UN(32, 0x1);
	RzILOpPure *u = UN(32, (ut32)ISA2IMM(hi, "u"));
