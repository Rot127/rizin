...
RzILOpEffect *hex_il_op_m6_vabsdiffb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st8_23 = CAST(64, IL_FALSE, op_AND_22);
	...
	RzILOpPure *op_MUL_34 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpPure *op_AND_40 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cond_39, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_41 = CAST(64, IL_FALSE, op_AND_40);
	RzILOpPure *op_MUL_42 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
