...
RzILOpEffect *hex_il_op_a6_vminub_rdp(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_24 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpPure *op_MUL_28 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_29 = SHIFTR0(DUP(Rtt), op_MUL_28);
	RzILOpPure *op_AND_30 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_29, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_31 = CAST(8, IL_FALSE, op_AND_30);
	RzILOpPure *op_MUL_32 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpPure *op_MUL_37 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_38 = SHIFTR0(DUP(Rtt), op_MUL_37);
	RzILOpPure *op_AND_39 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_38, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_40 = CAST(64, IL_FALSE, op_AND_39);
	RzILOpPure *op_MUL_41 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_42 = SHIFTR0(DUP(Rss), op_MUL_41);
	RzILOpPure *op_AND_43 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_42, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_44 = CAST(8, IL_FALSE, op_AND_43);
	RzILOpPure *cond_45 = ITE(op_LT_36, cast_ut8_40, cast_ut8_44);
	RzILOpPure *op_AND_46 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cond_45, VARLP("const_pos0x0ffLL")));
