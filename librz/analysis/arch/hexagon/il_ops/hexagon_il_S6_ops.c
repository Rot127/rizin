...
RzILOpEffect *hex_il_op_s6_vtrunehb_ppp(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_23 = LET("const_pos4", const_pos4, ADD(VARL("i"), VARLP("const_pos4")));
	...
	RzILOpPure *op_ADD_35 = LET("const_pos4", const_pos4, ADD(VARL("i"), VARLP("const_pos4")));
	RzILOpPure *op_MUL_36 = LET("const_pos8", const_pos8, MUL(op_ADD_35, VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_s6_vtrunohb_ppp(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_24 = LET("const_pos4", const_pos4, ADD(VARL("i"), VARLP("const_pos4")));
	...
	RzILOpPure *op_ADD_37 = LET("const_pos4", const_pos4, ADD(VARL("i"), VARLP("const_pos4")));
	RzILOpPure *op_MUL_38 = LET("const_pos8", const_pos8, MUL(op_ADD_37, VARLP("const_pos8")));
