...
RzILOpEffect *hex_il_op_m4_cmpyi_wh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NE_25 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_34 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_25, VARL("h_tmp1"), VARLP("const_pos0LL")));
	...
	RzILOpPure *cond_43 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_0, VARL("h_tmp2"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_NE_51 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_60 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_51, VARL("h_tmp3"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_61 = MUL(cast_st64_50, cond_60);
	RzILOpPure *op_MUL_62 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_NE_69 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_78 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_69, VARL("h_tmp4"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_79 = MUL(cast_st64_68, cond_78);
	RzILOpPure *op_ADD_80 = ADD(op_MUL_61, op_MUL_79);
	RzILOpPure *op_ADD_81 = LET("const_pos0x4000", DUP(const_pos0x4000), ADD(op_ADD_80, VARLP("const_pos0x4000")));
	RzILOpPure *op_RSHIFT_82 = LET("const_pos15", DUP(const_pos15), SHIFTR0(op_ADD_81, VARLP("const_pos15")));
	...
	RzILOpPure *op_NE_91 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_100 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_91, VARL("h_tmp5"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_AND_112 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_111, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_113 = CAST(16, MSB(op_AND_112), op_AND_112);
	RzILOpPure *cond_118 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_109, VARL("h_tmp6"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_119 = MUL(cast_st64_108, cond_118);
	RzILOpPure *op_ADD_120 = ADD(op_MUL_101, op_MUL_119);
	RzILOpPure *op_ADD_121 = LET("const_pos0x4000", DUP(const_pos0x4000), ADD(op_ADD_120, VARLP("const_pos0x4000")));
	RzILOpPure *op_RSHIFT_122 = LET("const_pos15", DUP(const_pos15), SHIFTR0(op_ADD_121, VARLP("const_pos15")));
	RzILOpPure *cond_139 = ITE(VARL("h_tmp7"), VARL("h_tmp10"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_142 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_NE_149 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_150 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_151 = SHIFTR0(DUP(Rt), op_MUL_150);
	RzILOpPure *op_AND_152 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_151, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_153 = CAST(16, MSB(op_AND_152), op_AND_152);
	RzILOpPure *cond_157 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_149, VARL("h_tmp11"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_158 = MUL(cast_st64_148, cond_157);
	RzILOpPure *op_MUL_159 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_160 = SHIFTR0(DUP(Rss), op_MUL_159);
	RzILOpPure *op_AND_161 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_160, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_MUL_167 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	...
	RzILOpPure *cond_175 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_166, VARL("h_tmp12"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_176 = MUL(cast_st64_165, cond_175);
	RzILOpPure *op_ADD_177 = ADD(op_MUL_158, op_MUL_176);
	RzILOpPure *op_ADD_178 = LET("const_pos0x4000", DUP(const_pos0x4000), ADD(op_ADD_177, VARLP("const_pos0x4000")));
	RzILOpPure *op_RSHIFT_179 = LET("const_pos15", DUP(const_pos15), SHIFTR0(op_ADD_178, VARLP("const_pos15")));
	RzILOpPure *op_LT_180 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_179, VARLP("const_pos0")));
	...
	RzILOpPure *op_SUB_184 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_185 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_184));
	RzILOpPure *op_SUB_186 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_185, VARLP("const_pos1")));
	RzILOpPure *cond_187 = ITE(op_LT_180, op_NEG_183, op_SUB_186);
	RzILOpPure *cond_189 = ITE(op_EQ_83, op_RSHIFT_122, cond_187);

	// WRITE
	RzILOpEffect *c_call_13 = HEX_SEXTRACT64(cast_st16_12, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_30 = HEX_SEXTRACT64(cast_st16_29, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_39 = HEX_SEXTRACT64(op_RSHIFT_38, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_56 = HEX_SEXTRACT64(cast_st16_55, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_74 = HEX_SEXTRACT64(cast_st16_73, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_96 = HEX_SEXTRACT64(cast_st16_95, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_114 = HEX_SEXTRACT64(cast_st16_113, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_135 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp8"), VARL("h_tmp9"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_154 = HEX_SEXTRACT64(cast_st16_153, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_171 = HEX_SEXTRACT64(cast_st16_170, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_m4_cmpyi_whc(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_81 = LET("const_pos0x4000", DUP(const_pos0x4000), ADD(op_SUB_80, VARLP("const_pos0x4000")));
	RzILOpPure *op_RSHIFT_82 = LET("const_pos15", DUP(const_pos15), SHIFTR0(op_ADD_81, VARLP("const_pos15")));
	RzILOpPure *op_EQ_83 = EQ(cond_43, op_RSHIFT_82);
	...
	RzILOpPure *cast_st64_90 = CAST(32, IL_FALSE, cast_st32_89);
	RzILOpPure *op_NE_91 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_92 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_93 = SHIFTR0(DUP(Rt), op_MUL_92);
	RzILOpPure *op_AND_94 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_93, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_95 = CAST(16, MSB(op_AND_94), op_AND_94);
	RzILOpPure *cond_100 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_91, VARL("h_tmp5"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_ADD_121 = LET("const_pos0x4000", DUP(const_pos0x4000), ADD(op_SUB_120, VARLP("const_pos0x4000")));
	RzILOpPure *op_RSHIFT_122 = LET("const_pos15", DUP(const_pos15), SHIFTR0(op_ADD_121, VARLP("const_pos15")));
	RzILOpPure *cond_139 = ITE(VARL("h_tmp7"), VARL("h_tmp10"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_142 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_143 = SHIFTR0(DUP(Rss), op_MUL_142);
	RzILOpPure *op_AND_144 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_143, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_145 = CAST(32, MSB(op_AND_144), op_AND_144);
	RzILOpPure *cast_st64_146 = CAST(64, MSB(cast_st32_145), cast_st32_145);
	...
	RzILOpPure *cast_st64_148 = CAST(32, IL_FALSE, cast_st32_147);
	RzILOpPure *op_NE_149 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_150 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_151 = SHIFTR0(DUP(Rt), op_MUL_150);
	RzILOpPure *op_AND_152 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_151, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_153 = CAST(16, MSB(op_AND_152), op_AND_152);
	RzILOpPure *cond_157 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_149, VARL("h_tmp11"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_158 = MUL(cast_st64_148, cond_157);
	RzILOpPure *op_MUL_159 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_160 = SHIFTR0(DUP(Rss), op_MUL_159);
	RzILOpPure *op_AND_161 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_160, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_162 = CAST(32, MSB(op_AND_161), op_AND_161);
	RzILOpPure *cast_st64_163 = CAST(64, MSB(cast_st32_162), cast_st32_162);
	...
	RzILOpPure *cast_st64_165 = CAST(64, MSB(cast_st32_164), cast_st32_164);
	RzILOpPure *op_NE_166 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_167 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_168 = SHIFTR0(DUP(Rt), op_MUL_167);
	RzILOpPure *op_AND_169 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_168, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_170 = CAST(16, MSB(op_AND_169), op_AND_169);
	RzILOpPure *cond_175 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_166, VARL("h_tmp12"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_ADD_178 = LET("const_pos0x4000", DUP(const_pos0x4000), ADD(op_SUB_177, VARLP("const_pos0x4000")));
	RzILOpPure *op_RSHIFT_179 = LET("const_pos15", DUP(const_pos15), SHIFTR0(op_ADD_178, VARLP("const_pos15")));
	RzILOpPure *op_LT_180 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_179, VARLP("const_pos0")));
	RzILOpPure *op_SUB_181 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_182 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_181));
...
RzILOpEffect *hex_il_op_m4_cmpyr_wh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_16 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_8, VARL("h_tmp0"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_17 = MUL(cast_st64_7, cond_16);
	RzILOpPure *op_MUL_18 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_19 = SHIFTR0(DUP(Rss), op_MUL_18);
	RzILOpPure *op_AND_20 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_19, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_21 = CAST(32, MSB(op_AND_20), op_AND_20);
	RzILOpPure *cast_st64_22 = CAST(64, MSB(cast_st32_21), cast_st32_21);
...
RzILOpEffect *hex_il_op_m4_mac_up_s1_sat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_21 = LET("const_pos31", DUP(const_pos31), SHIFTR0(op_MUL_20, VARLP("const_pos31")));
	...
	RzILOpPure *op_RSHIFT_31 = LET("const_pos31", DUP(const_pos31), SHIFTR0(op_MUL_30, VARLP("const_pos31")));
	...
	RzILOpPure *op_RSHIFT_59 = LET("const_pos31", DUP(const_pos31), SHIFTR0(op_MUL_58, VARLP("const_pos31")));
	...
	// WRITE
	RzILOpEffect *c_call_10 = HEX_SEXTRACT64(op_ADD_9, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_m4_nac_up_s1_sat(HexInsnPktBundle *bundle) {
	...
	// WRITE
	RzILOpEffect *c_call_10 = HEX_SEXTRACT64(op_SUB_9, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_11 = SETL("h_tmp0", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_12 = SEQN(2, c_call_10, op_ASSIGN_hybrid_tmp_11);
	RzILOpEffect *c_call_33 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_34 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_m4_vrmpyeh_acc_s0(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_18 = LET("const_pos0", DUP(const_pos0), SHIFTL0(cast_st64_17, VARLP("const_pos0")));
	...
	RzILOpPure *cast_st64_25 = CAST(64, MSB(cast_st32_24), cast_st32_24);
	RzILOpPure *op_NE_26 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_35 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_26, VARL("h_tmp1"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_36 = MUL(cast_st64_25, cond_35);
	RzILOpPure *cast_st64_37 = CAST(64, MSB(op_MUL_36), op_MUL_36);
	RzILOpPure *op_LSHIFT_38 = LET("const_pos0", DUP(const_pos0), SHIFTL0(cast_st64_37, VARLP("const_pos0")));
	RzILOpPure *op_ADD_39 = ADD(op_LSHIFT_18, op_LSHIFT_38);
	RzILOpPure *addop_ADD_39Rxx = ADD(op_ADD_39, Rxx);

	// WRITE
	RzILOpEffect *c_call_12 = HEX_SEXTRACT64(cast_st16_11, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_31 = HEX_SEXTRACT64(cast_st16_30, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_m4_vrmpyeh_acc_s1(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_16 = MUL(cast_st64_6, cond_15);
	RzILOpPure *cast_st64_17 = CAST(64, IL_FALSE, op_MUL_16);
	RzILOpPure *op_LSHIFT_18 = LET("const_pos1", DUP(const_pos1), SHIFTL0(cast_st64_17, VARLP("const_pos1")));
	RzILOpPure *op_MUL_19 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_20 = SHIFTR0(DUP(Rss), op_MUL_19);
	RzILOpPure *op_AND_21 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_20, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_22 = CAST(32, MSB(op_AND_21), op_AND_21);
	...
	RzILOpPure *op_MUL_36 = MUL(cast_st64_25, cond_35);
	RzILOpPure *cast_st64_37 = CAST(64, MSB(op_MUL_36), op_MUL_36);
	RzILOpPure *op_LSHIFT_38 = LET("const_pos1", DUP(const_pos1), SHIFTL0(cast_st64_37, VARLP("const_pos1")));
	RzILOpPure *op_ADD_39 = ADD(op_LSHIFT_18, op_LSHIFT_38);
	RzILOpPure *addop_ADD_39Rxx = ADD(op_ADD_39, Rxx);
