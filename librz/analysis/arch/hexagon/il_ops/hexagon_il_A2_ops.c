...
RzILOpEffect *hex_il_op_a2_abssat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_3 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_2, VARLP("const_pos0")));
	...
	RzILOpPure *op_LT_16 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_15, VARLP("const_pos0")));
	...
	RzILOpPure *op_LT_26 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_25, VARLP("const_pos0")));
	...
	RzILOpPure *op_LT_54 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_53, VARLP("const_pos0")));
	...
	RzILOpPure *op_LT_61 = LET("const_pos0", DUP(const_pos0), ULT(cond_60, VARLP("const_pos0")));
	RzILOpPure *op_SUB_62 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_65 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_66 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_65));
	RzILOpPure *op_SUB_67 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_66, VARLP("const_pos1")));
	RzILOpPure *cond_68 = ITE(op_LT_61, op_NEG_64, op_SUB_67);
	RzILOpPure *cond_69 = ITE(op_EQ_23, cond_32, cond_68);

	// WRITE
	RzILOpEffect *c_call_10 = HEX_SEXTRACT64(cond_9, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_45 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_addh_h16_sat_hh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_13 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_0, VARL("h_tmp0"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_14 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_15 = SHIFTR0(DUP(Rt), op_MUL_14);
	RzILOpPure *op_AND_16 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_15, VARLP("const_pos0xffff")));
	...
	RzILOpPure *cond_49 = ITE(VARL("h_tmp1"), VARL("h_tmp4"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_52 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_LT_61 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_60, VARLP("const_pos0")));
	...
	RzILOpPure *op_LSHIFT_70 = LET("const_pos16", DUP(const_pos16), SHIFTL0(cond_69, VARLP("const_pos16")));

	// WRITE
	RzILOpEffect *c_call_10 = HEX_SEXTRACT64(op_ADD_9, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_a2_addh_h16_sat_hl(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_54 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_53, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_55 = CAST(32, IL_FALSE, op_AND_54);
	RzILOpPure *op_MUL_56 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_57 = SHIFTR0(DUP(Rs), op_MUL_56);
	RzILOpPure *op_AND_58 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_57, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_59 = CAST(16, MSB(op_AND_58), op_AND_58);
	RzILOpPure *op_ADD_60 = ADD(cast_st16_55, cast_st16_59);
...
RzILOpEffect *hex_il_op_a2_addh_h16_sat_lh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_9 = ADD(cast_st16_4, cast_st16_8);
	RzILOpPure *cond_13 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_0, VARL("h_tmp0"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_14 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_15 = SHIFTR0(DUP(Rt), op_MUL_14);
	RzILOpPure *op_AND_16 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_15, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_17 = CAST(16, MSB(op_AND_16), op_AND_16);
	RzILOpPure *op_MUL_18 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
...
RzILOpEffect *hex_il_op_a2_addh_h16_sat_ll(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_60 = ADD(cast_st16_55, cast_st16_59);
	RzILOpPure *op_LT_61 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_60, VARLP("const_pos0")));
	RzILOpPure *op_SUB_62 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_63 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_62));
	RzILOpPure *op_NEG_64 = NEG(op_LSHIFT_63);
	RzILOpPure *op_SUB_65 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_66 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_65));
...
RzILOpEffect *hex_il_op_a2_addpsat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_30 = ITE(VARL("h_tmp0"), VARL("h_tmp3"), VARG(usr_assoc_tmp));
	RzILOpPure *cond_49 = ITE(VARL("h_tmp4"), VARL("h_tmp7"), VARG(usr_assoc_tmp));
	...
	RzILOpEffect *op_ASSIGN_14 = SETG(Rdd_assoc_tmp, LET("const_pos0x7FFFFFFFFFFFFFFFLL", const_pos0x7FFFFFFFFFFFFFFFLL, VARLP("const_pos0x7FFFFFFFFFFFFFFFLL")));
	RzILOpEffect *c_call_15 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_16 = SETL("h_tmp0", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_23 = SETL("h_tmp2", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_24 = SEQN(2, c_call_22, op_ASSIGN_hybrid_tmp_23);
	RzILOpEffect *seq_25 = SEQN(2, seq_21, seq_24);
	RzILOpEffect *c_call_26 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp1"), VARL("h_tmp2"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_27 = SETL("h_tmp3", UNSIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_28 = SEQN(2, c_call_26, op_ASSIGN_hybrid_tmp_27);
	RzILOpEffect *seq_29 = SEQN(2, seq_25, seq_28);
	RzILOpEffect *op_ASSIGN_31 = SETG(usr_assoc_tmp, cond_30);
	RzILOpEffect *seq_32 = SEQN(2, seq_29, op_ASSIGN_31);
	RzILOpEffect *op_ASSIGN_33 = SETG(Rdd_assoc_tmp, LET("const_pos0x8000000000000000LL", const_pos0x8000000000000000LL, VARLP("const_pos0x8000000000000000LL")));
	...
	RzILOpEffect *c_call_37 = HEX_REGFIELD(HEX_RF_OFFSET, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_38 = SETL("h_tmp5", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_39 = SEQN(2, c_call_37, op_ASSIGN_hybrid_tmp_38);
	RzILOpEffect *seq_40 = SEQN(2, seq_36, seq_39);
	RzILOpEffect *c_call_41 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_42 = SETL("h_tmp6", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_43 = SEQN(2, c_call_41, op_ASSIGN_hybrid_tmp_42);
	RzILOpEffect *seq_44 = SEQN(2, seq_40, seq_43);
	RzILOpEffect *c_call_45 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp5"), VARL("h_tmp6"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_46 = SETL("h_tmp7", UNSIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_47 = SEQN(2, c_call_45, op_ASSIGN_hybrid_tmp_46);
	RzILOpEffect *seq_48 = SEQN(2, seq_44, seq_47);
	RzILOpEffect *op_ASSIGN_50 = SETG(usr_assoc_tmp, cond_49);
	RzILOpEffect *seq_51 = SEQN(2, seq_48, op_ASSIGN_50);
	RzILOpEffect *seq_then_52 = SEQN(2, op_ASSIGN_14, seq_32);
	RzILOpEffect *seq_else_54 = SEQN(2, op_ASSIGN_33, seq_51);
	RzILOpEffect *branch_53 = BRANCH(op_AND_13, seq_then_52, seq_else_54);
	RzILOpEffect *op_ASSIGN_55 = SETG(Rdd_assoc_tmp, VARL("__sum"));
	RzILOpEffect *seq_then_56 = SEQN(1, branch_53);
	RzILOpEffect *seq_else_58 = SEQN(1, op_ASSIGN_55);
	RzILOpEffect *branch_57 = BRANCH(op_AND_12, seq_then_56, seq_else_58);
	RzILOpEffect *seq_then_59 = SEQN(1, op_ASSIGN_10);
	RzILOpEffect *seq_else_61 = SEQN(1, branch_57);
	RzILOpEffect *branch_60 = BRANCH(op_AND_9, seq_then_59, seq_else_61);
	RzILOpEffect *empty_62 = EMPTY();
	RzILOpEffect *instruction_sequence = SEQN(7, op_ASSIGN_1, op_ASSIGN_3, op_ASSIGN_5, op_ASSIGN_7, op_ASSIGN_8, branch_60, empty_62);
...
RzILOpEffect *hex_il_op_a2_addsph(HexInsnPktBundle *bundle) {
	...
	// WRITE
	RzILOpEffect *c_call_6 = HEX_SEXTRACT64(cast_st64_5, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_combine_hh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *Rt = VARG(Rt_assoc);
	RzILOpPure *const_pos1 = UN(32, 0x1);
	RzILOpPure *const_pos16 = UN(16, 0x10);
	RzILOpPure *const_pos0xffff = UN(32, 0xffff);
	const char *Rs_assoc = ISA2REG(hi, 's', false);
	RzILOpPure *Rs = VARG(Rs_assoc);
...
RzILOpEffect *hex_il_op_a2_combineii(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_4 = LET("S", S, LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(VARLP("S"), VARLP("const_pos0x0ffffffffLL"))));
	...
	RzILOpPure *op_AND_14 = LET("s", s, LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(VARLP("s"), VARLP("const_pos0x0ffffffffLL"))));
...
RzILOpEffect *hex_il_op_a2_combinew(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NOT_2 = LOGNOT(op_LSHIFT_1);
	RzILOpPure *op_AND_3 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_2);
	RzILOpPure *op_AND_4 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(Rt, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_5 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_6 = SHIFTL0(op_AND_4, op_MUL_5);
	RzILOpPure *op_OR_7 = LOGOR(op_AND_3, op_LSHIFT_6);
	RzILOpPure *op_MUL_10 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
...
RzILOpEffect *hex_il_op_a2_negsat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_33 = LET("const_pos0", DUP(const_pos0), ULT(op_NEG_32, VARLP("const_pos0")));
	RzILOpPure *op_SUB_34 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_37 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_38 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_37));
	RzILOpPure *op_SUB_39 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_38, VARLP("const_pos1")));
	RzILOpPure *cond_40 = ITE(op_LT_33, op_NEG_36, op_SUB_39);
	RzILOpPure *cond_41 = ITE(op_EQ_9, op_NEG_11, cond_40);

	// WRITE
	RzILOpEffect *c_call_3 = HEX_SEXTRACT64(op_NEG_2, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_24 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_sat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_25 = LET("const_pos0", DUP(const_pos0), ULT(DUP(Rss), VARLP("const_pos0")));
	RzILOpPure *op_SUB_26 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_29 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_30 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_29));
	RzILOpPure *op_SUB_31 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_30, VARLP("const_pos1")));
	RzILOpPure *cond_32 = ITE(op_LT_25, op_NEG_28, op_SUB_31);
	RzILOpPure *cond_33 = ITE(op_EQ_5, DUP(Rss), cond_32);

	// WRITE
	RzILOpEffect *c_call_1 = HEX_SEXTRACT64(DUP(Rss), LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_18 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_satb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_22 = ITE(VARL("h_tmp1"), VARL("h_tmp4"), VARG(usr_assoc_tmp));
	RzILOpPure *op_LT_25 = LET("const_pos0", DUP(const_pos0), ULT(DUP(Rs), VARLP("const_pos0")));
	RzILOpPure *op_SUB_26 = LET("const_pos8", DUP(const_pos8), LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_27 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_26));
	RzILOpPure *op_NEG_28 = NEG(op_LSHIFT_27);
	RzILOpPure *op_SUB_29 = LET("const_pos8", DUP(const_pos8), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_30 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_29));
	RzILOpPure *op_SUB_31 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_30, VARLP("const_pos1")));
	RzILOpPure *cond_32 = ITE(op_LT_25, op_NEG_28, op_SUB_31);
	...
	// WRITE
	RzILOpEffect *c_call_1 = HEX_SEXTRACT64(DUP(Rs), LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos8", DUP(const_pos8), VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_a2_sath(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_22 = ITE(VARL("h_tmp1"), VARL("h_tmp4"), VARG(usr_assoc_tmp));
	RzILOpPure *op_LT_25 = LET("const_pos0", DUP(const_pos0), ULT(DUP(Rs), VARLP("const_pos0")));
	RzILOpPure *op_SUB_26 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_27 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_26));
	RzILOpPure *op_NEG_28 = NEG(op_LSHIFT_27);
	RzILOpPure *op_SUB_29 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_30 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_29));
	RzILOpPure *op_SUB_31 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_30, VARLP("const_pos1")));
	RzILOpPure *cond_32 = ITE(op_LT_25, op_NEG_28, op_SUB_31);
	RzILOpPure *cond_33 = ITE(op_EQ_5, DUP(Rs), cond_32);
	...
	// WRITE
	RzILOpEffect *c_call_1 = HEX_SEXTRACT64(DUP(Rs), LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_2 = SETL("h_tmp0", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_3 = SEQN(2, c_call_1, op_ASSIGN_hybrid_tmp_2);
	RzILOpEffect *c_call_6 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_7 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_a2_satub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_22 = ITE(VARL("h_tmp1"), VARL("h_tmp4"), VARG(usr_assoc_tmp));
	RzILOpPure *op_LT_25 = LET("const_pos0", DUP(const_pos0), ULT(DUP(Rs), VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_26 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", DUP(const_pos8), SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	RzILOpPure *op_SUB_27 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_26, VARLP("const_pos1")));
	RzILOpPure *cond_28 = LET("const_pos0", DUP(const_pos0), ITE(op_LT_25, VARLP("const_pos0"), op_SUB_27));
	RzILOpPure *cond_29 = ITE(op_EQ_5, DUP(Rs), cond_28);

	// WRITE
	RzILOpEffect *c_call_1 = HEX_EXTRACT64(DUP(Rs), LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos8", DUP(const_pos8), VARLP("const_pos8")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_2 = SETL("h_tmp0", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_3 = SEQN(2, c_call_1, op_ASSIGN_hybrid_tmp_2);
	RzILOpEffect *c_call_6 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_7 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_a2_satuh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_22 = ITE(VARL("h_tmp1"), VARL("h_tmp4"), VARG(usr_assoc_tmp));
	RzILOpPure *op_LT_25 = LET("const_pos0", DUP(const_pos0), ULT(DUP(Rs), VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_26 = LET("const_pos1LL", const_pos1LL, LET("const_pos16", DUP(const_pos16), SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos16"))));
	RzILOpPure *op_SUB_27 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_26, VARLP("const_pos1")));
	RzILOpPure *cond_28 = LET("const_pos0", DUP(const_pos0), ITE(op_LT_25, VARLP("const_pos0"), op_SUB_27));
	RzILOpPure *cond_29 = ITE(op_EQ_5, DUP(Rs), cond_28);

	// WRITE
	RzILOpEffect *c_call_1 = HEX_EXTRACT64(DUP(Rs), LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_2 = SETL("h_tmp0", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_3 = SEQN(2, c_call_1, op_ASSIGN_hybrid_tmp_2);
	RzILOpEffect *c_call_6 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_7 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_a2_subh_h16_sat_hh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_61 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_60, VARLP("const_pos0")));
	RzILOpPure *op_SUB_62 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_63 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_62));
	RzILOpPure *op_NEG_64 = NEG(op_LSHIFT_63);
	RzILOpPure *op_SUB_65 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	// WRITE
	RzILOpEffect *c_call_10 = HEX_SEXTRACT64(op_SUB_9, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_11 = SETL("h_tmp0", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_12 = SEQN(2, c_call_10, op_ASSIGN_hybrid_tmp_11);
	RzILOpEffect *c_call_33 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_34 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_a2_svaddh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_14 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_21 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_a2_svaddhs(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_35 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_36 = SHIFTR0(DUP(Rs), op_MUL_35);
	RzILOpPure *op_AND_37 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_36, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_38 = CAST(32, IL_FALSE, op_AND_37);
	RzILOpPure *op_MUL_39 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_AND_69 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_68, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_70 = CAST(16, MSB(op_AND_69), op_AND_69);
	RzILOpPure *op_ADD_71 = ADD(cast_st16_66, cast_st16_70);
	RzILOpPure *op_LT_72 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_71, VARLP("const_pos0")));
	RzILOpPure *op_SUB_73 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_76 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_77 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_76));
	RzILOpPure *op_SUB_78 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_77, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_83 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_20 = HEX_SEXTRACT64(op_ADD_19, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_56 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_svadduhs(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_72 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_71, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_73 = LET("const_pos1LL", const_pos1LL, LET("const_pos16", DUP(const_pos16), SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos16"))));
	RzILOpPure *op_SUB_74 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_73, VARLP("const_pos1")));
	RzILOpPure *cond_75 = LET("const_pos0", DUP(const_pos0), ITE(op_LT_72, VARLP("const_pos0"), op_SUB_74));
	...
	RzILOpPure *op_MUL_79 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_20 = HEX_EXTRACT64(op_ADD_19, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_a2_svavghs(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_20 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_19, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_svsubhs(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_72 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_71, VARLP("const_pos0")));
	RzILOpPure *op_SUB_73 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_74 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_73));
	RzILOpPure *op_NEG_75 = NEG(op_LSHIFT_74);
	RzILOpPure *op_SUB_76 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_20 = HEX_SEXTRACT64(op_SUB_19, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_21 = SETL("h_tmp1", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_22 = SEQN(2, c_call_20, op_ASSIGN_hybrid_tmp_21);
	RzILOpEffect *seq_23 = SEQN(2, seq_5, seq_22);
	RzILOpEffect *c_call_44 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
...
RzILOpEffect *hex_il_op_a2_svsubuhs(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_20 = HEX_EXTRACT64(op_SUB_19, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_21 = SETL("h_tmp1", UNSIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_22 = SEQN(2, c_call_20, op_ASSIGN_hybrid_tmp_21);
	RzILOpEffect *seq_23 = SEQN(2, seq_5, seq_22);
	RzILOpEffect *c_call_44 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
...
RzILOpEffect *hex_il_op_a2_swiz(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_4 = LET("const_pos3", const_pos3, LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
	RzILOpPure *op_RSHIFT_5 = SHIFTR0(Rs, op_MUL_4);
	RzILOpPure *op_AND_6 = LET("const_pos0xff", const_pos0xff, LOGAND(op_RSHIFT_5, VARLP("const_pos0xff")));
	RzILOpPure *cast_st8_7 = CAST(64, IL_FALSE, op_AND_6);
	RzILOpPure *op_AND_8 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cast_st8_7, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_9 = CAST(64, IL_FALSE, op_AND_8);
	RzILOpPure *op_MUL_10 = LET("const_pos0", DUP(const_pos0), LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos0"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_11 = SHIFTL0(cast_ut64_9, op_MUL_10);
	RzILOpPure *op_OR_12 = LOGOR(op_AND_3, op_LSHIFT_11);
	RzILOpPure *op_MUL_15 = LET("const_pos1", const_pos1, LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos1"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_16 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_15));
	RzILOpPure *op_NOT_17 = LOGNOT(op_LSHIFT_16);
	RzILOpPure *op_AND_18 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_17);
	RzILOpPure *op_MUL_19 = LET("const_pos2", const_pos2, LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos2"), VARLP("const_pos8"))));
	RzILOpPure *op_RSHIFT_20 = SHIFTR0(DUP(Rs), op_MUL_19);
	RzILOpPure *op_AND_21 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_20, VARLP("const_pos0xff")));
	RzILOpPure *cast_st8_22 = CAST(64, IL_FALSE, op_AND_21);
	RzILOpPure *op_AND_23 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cast_st8_22, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_24 = CAST(64, IL_FALSE, op_AND_23);
	RzILOpPure *op_MUL_25 = LET("const_pos1", DUP(const_pos1), LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos1"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_26 = SHIFTL0(cast_ut64_24, op_MUL_25);
	RzILOpPure *op_OR_27 = LOGOR(op_AND_18, op_LSHIFT_26);
	RzILOpPure *op_MUL_30 = LET("const_pos2", DUP(const_pos2), LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos2"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_31 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_30));
	...
	RzILOpPure *op_MUL_45 = LET("const_pos3", DUP(const_pos3), LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_46 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_45));
	RzILOpPure *op_NOT_47 = LOGNOT(op_LSHIFT_46);
	RzILOpPure *op_AND_48 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_47);
	RzILOpPure *op_MUL_49 = LET("const_pos0", DUP(const_pos0), LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos0"), VARLP("const_pos8"))));
	RzILOpPure *op_RSHIFT_50 = SHIFTR0(DUP(Rs), op_MUL_49);
	RzILOpPure *op_AND_51 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_50, VARLP("const_pos0xff")));
	RzILOpPure *cast_st8_52 = CAST(64, IL_FALSE, op_AND_51);
	RzILOpPure *op_AND_53 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cast_st8_52, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_54 = CAST(64, IL_FALSE, op_AND_53);
	RzILOpPure *op_MUL_55 = LET("const_pos3", DUP(const_pos3), LET("const_pos8", DUP(const_pos8), MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
...
RzILOpEffect *hex_il_op_a2_vabsh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_27 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_a2_vabshsat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_15 = LET("const_pos0", DUP(const_pos0), ULT(cast_st16_14, VARLP("const_pos0")));
	...
	RzILOpPure *op_AND_18 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_17, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_31 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_LT_35 = LET("const_pos0", DUP(const_pos0), ULT(cast_st16_34, VARLP("const_pos0")));
	RzILOpPure *op_MUL_36 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_37 = SHIFTR0(DUP(Rss), op_MUL_36);
	RzILOpPure *op_AND_38 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_37, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_39 = CAST(16, MSB(op_AND_38), op_AND_38);
	RzILOpPure *op_NEG_40 = NEG(cast_st16_39);
	RzILOpPure *op_MUL_41 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_47 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_LT_51 = LET("const_pos0", DUP(const_pos0), ULT(cast_st16_50, VARLP("const_pos0")));
	RzILOpPure *op_MUL_52 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_53 = SHIFTR0(DUP(Rss), op_MUL_52);
	RzILOpPure *op_AND_54 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_53, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_55 = CAST(32, IL_FALSE, op_AND_54);
	RzILOpPure *op_NEG_56 = NEG(cast_st16_55);
	RzILOpPure *op_MUL_57 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_58 = SHIFTR0(DUP(Rss), op_MUL_57);
	RzILOpPure *op_AND_59 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_58, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_81 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_LT_85 = LET("const_pos0", DUP(const_pos0), ULT(cast_st16_84, VARLP("const_pos0")));
	RzILOpPure *op_MUL_86 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_87 = SHIFTR0(DUP(Rss), op_MUL_86);
	RzILOpPure *op_AND_88 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_87, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_89 = CAST(32, IL_FALSE, op_AND_88);
	RzILOpPure *op_NEG_90 = NEG(cast_st16_89);
	RzILOpPure *op_MUL_91 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_LT_96 = LET("const_pos0", DUP(const_pos0), ULT(cond_95, VARLP("const_pos0")));
	RzILOpPure *op_SUB_97 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_100 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_101 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_100));
	RzILOpPure *op_SUB_102 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_101, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_107 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_26 = HEX_SEXTRACT64(cond_25, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_74 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_vabsw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_16 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_17 = SHIFTR0(DUP(Rss), op_MUL_16);
	...
	RzILOpPure *op_AND_28 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_27, VARLP("const_pos0x0ffffffffLL")));
...
RzILOpEffect *hex_il_op_a2_vabswsat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NOT_8 = LOGNOT(op_LSHIFT_7);
	RzILOpPure *op_AND_9 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_8);
	RzILOpPure *op_NE_10 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	...
	RzILOpPure *op_MUL_23 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_LT_39 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_38, VARLP("const_pos0")));
	RzILOpPure *op_MUL_40 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_MUL_46 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_47 = SHIFTR0(DUP(Rss), op_MUL_46);
	RzILOpPure *op_AND_48 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_47, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_MUL_53 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_54 = SHIFTR0(DUP(Rss), op_MUL_53);
	RzILOpPure *op_AND_55 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_54, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_56 = CAST(32, MSB(op_AND_55), op_AND_55);
	RzILOpPure *cast_st64_57 = CAST(32, IL_FALSE, cast_st32_56);
	RzILOpPure *op_LT_58 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_57, VARLP("const_pos0")));
	RzILOpPure *op_MUL_59 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_60 = SHIFTR0(DUP(Rss), op_MUL_59);
	RzILOpPure *op_AND_61 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_60, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_MUL_65 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_MUL_90 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_91 = SHIFTR0(DUP(Rss), op_MUL_90);
	RzILOpPure *op_AND_92 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_91, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_93 = CAST(32, MSB(op_AND_92), op_AND_92);
	RzILOpPure *cast_st64_94 = CAST(32, IL_FALSE, cast_st32_93);
	RzILOpPure *op_LT_95 = LET("const_pos0", DUP(const_pos0), ULT(cast_st64_94, VARLP("const_pos0")));
	RzILOpPure *op_MUL_96 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_97 = SHIFTR0(DUP(Rss), op_MUL_96);
	RzILOpPure *op_AND_98 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_97, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_MUL_102 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_LT_108 = LET("const_pos0", DUP(const_pos0), ULT(cond_107, VARLP("const_pos0")));
	RzILOpPure *op_SUB_109 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_112 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_113 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_112));
	RzILOpPure *op_SUB_114 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_113, VARLP("const_pos1")));
	RzILOpPure *cond_115 = ITE(op_LT_108, op_NEG_111, op_SUB_114);
	RzILOpPure *cond_116 = ITE(op_EQ_52, cond_70, cond_115);
	RzILOpPure *op_AND_117 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_116, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_118 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_29 = HEX_SEXTRACT64(cond_28, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_83 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_vaddub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NOT_8 = LOGNOT(op_LSHIFT_7);
	RzILOpPure *op_AND_9 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_8);
	RzILOpPure *op_MUL_10 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_11 = SHIFTR0(Rss, op_MUL_10);
	...
	RzILOpPure *op_MUL_14 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_15 = SHIFTR0(Rtt, op_MUL_14);
	RzILOpPure *op_AND_16 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_15, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_17 = CAST(8, IL_FALSE, op_AND_16);
	RzILOpPure *op_ADD_18 = ADD(cast_ut8_13, cast_ut8_17);
	RzILOpPure *op_AND_19 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(op_ADD_18, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_20 = CAST(64, IL_FALSE, op_AND_19);
	RzILOpPure *op_MUL_21 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_LSHIFT_22 = SHIFTL0(cast_ut64_20, op_MUL_21);
	RzILOpPure *op_OR_23 = LOGOR(op_AND_9, op_LSHIFT_22);
...
RzILOpEffect *hex_il_op_a2_vaddubs(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_11 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_12 = SHIFTR0(Rss, op_MUL_11);
	...
	RzILOpPure *op_MUL_15 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_16 = SHIFTR0(Rtt, op_MUL_15);
	RzILOpPure *op_AND_17 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_16, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_18 = CAST(8, IL_FALSE, op_AND_17);
	RzILOpPure *op_ADD_19 = ADD(cast_ut8_14, cast_ut8_18);
	RzILOpPure *cond_24 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_10, VARL("h_tmp1"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_25 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_26 = SHIFTR0(DUP(Rss), op_MUL_25);
	RzILOpPure *op_AND_27 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_26, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_28 = CAST(8, IL_FALSE, op_AND_27);
	RzILOpPure *op_MUL_29 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_30 = SHIFTR0(DUP(Rtt), op_MUL_29);
	...
	RzILOpPure *op_EQ_34 = EQ(cond_24, op_ADD_33);
	RzILOpPure *op_MUL_35 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_36 = SHIFTR0(DUP(Rss), op_MUL_35);
	RzILOpPure *op_AND_37 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_36, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_38 = CAST(64, IL_FALSE, op_AND_37);
	RzILOpPure *op_MUL_39 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_40 = SHIFTR0(DUP(Rtt), op_MUL_39);
	...
	RzILOpPure *op_RSHIFT_64 = SHIFTR0(DUP(Rss), op_MUL_63);
	RzILOpPure *op_AND_65 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_64, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_66 = CAST(32, IL_FALSE, op_AND_65);
	RzILOpPure *op_MUL_67 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_68 = SHIFTR0(DUP(Rtt), op_MUL_67);
	...
	RzILOpPure *op_LT_72 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_71, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_73 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", DUP(const_pos8), SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	RzILOpPure *op_SUB_74 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_73, VARLP("const_pos1")));
	RzILOpPure *cond_75 = LET("const_pos0", DUP(const_pos0), ITE(op_LT_72, VARLP("const_pos0"), op_SUB_74));
	RzILOpPure *cond_76 = ITE(op_EQ_34, op_ADD_43, cond_75);
	RzILOpPure *op_AND_77 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cond_76, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_78 = CAST(64, IL_FALSE, op_AND_77);
	RzILOpPure *op_MUL_79 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_LSHIFT_80 = SHIFTL0(cast_ut64_78, op_MUL_79);
	RzILOpPure *op_OR_81 = LOGOR(op_AND_9, op_LSHIFT_80);
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_20 = HEX_EXTRACT64(op_ADD_19, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos8", DUP(const_pos8), VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_a2_vaddw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_21 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_20, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_22 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vaddws(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st64_31 = CAST(64, MSB(cast_st32_30), cast_st32_30);
	RzILOpPure *op_MUL_32 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_MUL_39 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_MUL_44 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_MUL_69 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_MUL_74 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_LT_80 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_79, VARLP("const_pos0")));
	RzILOpPure *op_SUB_81 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_86 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_85, VARLP("const_pos1")));
	RzILOpPure *cond_87 = ITE(op_LT_80, op_NEG_83, op_SUB_86);
	RzILOpPure *cond_88 = ITE(op_EQ_38, op_ADD_49, cond_87);
	RzILOpPure *op_AND_89 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_88, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_90 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_22 = HEX_SEXTRACT64(op_ADD_21, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_62 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_vavghcr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_EQ_20 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_19, VARLP("const_pos0x3")));
	RzILOpPure *op_MUL_21 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_22 = SHIFTR0(DUP(Rss), op_MUL_21);
	RzILOpPure *op_AND_23 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_22, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_RSHIFT_41 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_40, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_44 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_a2_vavgub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_18 = ADD(cast_ut8_13, cast_ut8_17);
	RzILOpPure *op_RSHIFT_19 = LET("const_pos1", const_pos1, SHIFTR0(op_ADD_18, VARLP("const_pos1")));
	RzILOpPure *op_AND_20 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(op_RSHIFT_19, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_21 = CAST(64, IL_FALSE, op_AND_20);
	RzILOpPure *op_MUL_22 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_LSHIFT_23 = SHIFTL0(cast_ut64_21, op_MUL_22);
	RzILOpPure *op_OR_24 = LOGOR(op_AND_9, op_LSHIFT_23);
...
RzILOpEffect *hex_il_op_a2_vavgubr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_19 = LET("const_pos1", const_pos1, ADD(op_ADD_18, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_20 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_19, VARLP("const_pos1")));
	RzILOpPure *op_AND_21 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(op_RSHIFT_20, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_22 = CAST(64, IL_FALSE, op_AND_21);
	RzILOpPure *op_MUL_23 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_LSHIFT_24 = SHIFTL0(cast_ut64_22, op_MUL_23);
	RzILOpPure *op_OR_25 = LOGOR(op_AND_9, op_LSHIFT_24);
...
RzILOpEffect *hex_il_op_a2_vavguw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NE_21 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_22 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_31 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_21, VARL("h_tmp2"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_AND_34 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_33, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_35 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_16 = HEX_EXTRACT64(cast_ut64_15, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_17 = SETL("h_tmp1", UNSIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_18 = SEQN(2, c_call_16, op_ASSIGN_hybrid_tmp_17);
	RzILOpEffect *seq_19 = SEQN(2, seq_5, seq_18);
	RzILOpEffect *c_call_27 = HEX_EXTRACT64(cast_ut64_26, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vavguwr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_34 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_33, VARLP("const_pos1")));
	RzILOpPure *op_AND_35 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_34, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_36 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vavgw(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_16 = HEX_SEXTRACT64(cast_st64_15, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_17 = SETL("h_tmp1", UNSIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_18 = SEQN(2, c_call_16, op_ASSIGN_hybrid_tmp_17);
	RzILOpEffect *seq_19 = SEQN(2, seq_5, seq_18);
	RzILOpEffect *c_call_27 = HEX_SEXTRACT64(cast_st64_26, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vavgwcr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_EQ_34 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_33, VARLP("const_pos0x3")));
	RzILOpPure *op_NE_35 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_36 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_37 = SHIFTR0(DUP(Rss), op_MUL_36);
	...
	RzILOpPure *cond_45 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_35, VARL("h_tmp3"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_47 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_56 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_46, VARL("h_tmp4"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_60 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_61 = SHIFTR0(DUP(Rss), op_MUL_60);
	RzILOpPure *op_AND_62 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_61, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_63 = CAST(32, MSB(op_AND_62), op_AND_62);
	RzILOpPure *cast_st64_64 = CAST(64, MSB(cast_st32_63), cast_st32_63);
	RzILOpPure *cond_69 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_59, VARL("h_tmp5"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_70 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_71 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_72 = SHIFTR0(DUP(Rtt), op_MUL_71);
	RzILOpPure *op_AND_73 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_72, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_74 = CAST(32, MSB(op_AND_73), op_AND_73);
	RzILOpPure *cast_st64_75 = CAST(64, MSB(cast_st32_74), cast_st32_74);
	RzILOpPure *cond_80 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_70, VARL("h_tmp6"), VARLP("const_pos0LL")));
	RzILOpPure *op_ADD_81 = ADD(cond_69, cond_80);
	RzILOpPure *cond_82 = ITE(op_EQ_34, op_ADD_58, op_ADD_81);
	RzILOpPure *op_RSHIFT_83 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_82, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_85 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *seq_29 = SEQN(2, c_call_27, op_ASSIGN_hybrid_tmp_28);
	RzILOpEffect *seq_30 = SEQN(2, seq_19, seq_29);
	RzILOpEffect *c_call_41 = HEX_SEXTRACT64(cast_st64_40, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_42 = SETL("h_tmp3", UNSIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_43 = SEQN(2, c_call_41, op_ASSIGN_hybrid_tmp_42);
	RzILOpEffect *seq_44 = SEQN(2, seq_30, seq_43);
	RzILOpEffect *c_call_52 = HEX_SEXTRACT64(cast_st64_51, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_53 = SETL("h_tmp4", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_54 = SEQN(2, c_call_52, op_ASSIGN_hybrid_tmp_53);
	RzILOpEffect *seq_55 = SEQN(2, seq_44, seq_54);
	RzILOpEffect *c_call_65 = HEX_SEXTRACT64(cast_st64_64, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_76 = HEX_SEXTRACT64(cast_st64_75, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vcmpbeq(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_9 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpPure *op_MUL_13 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_14 = SHIFTR0(Rtt, op_MUL_13);
	RzILOpPure *op_AND_15 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_14, VARLP("const_pos0xff")));
...
RzILOpEffect *hex_il_op_a2_vcmpheq(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_20 = LET("const_pos2", DUP(const_pos2), MUL(VARL("i"), VARLP("const_pos2")));
	...
	RzILOpPure *op_LSHIFT_28 = LET("const_pos1ULL", DUP(const_pos1ULL), SHIFTL0(VARLP("const_pos1ULL"), op_ADD_27));
	...
	RzILOpPure *op_MUL_41 = LET("const_pos2", DUP(const_pos2), MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_42 = LET("const_pos1", DUP(const_pos1), ADD(op_MUL_41, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_vcmpweq(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_34 = LET("const_pos1ULL", DUP(const_pos1ULL), SHIFTL0(VARLP("const_pos1ULL"), VARL("j")));
	RzILOpPure *op_NOT_35 = LOGNOT(op_LSHIFT_34);
	RzILOpPure *op_AND_36 = LOGAND(VARG(Pd_assoc_tmp), op_NOT_35);
	RzILOpPure *op_MUL_37 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_MUL_42 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_EQ_47 = EQ(cast_st64_41, cast_st64_46);
	RzILOpPure *cast_ut64_48 = CAST(64, IL_FALSE, op_EQ_47);
	RzILOpPure *op_LSHIFT_49 = SHIFTL0(cast_ut64_48, VARL("j"));
	RzILOpPure *op_OR_50 = LOGOR(op_AND_36, op_LSHIFT_49);

	// WRITE
	RzILOpEffect *empty_0 = EMPTY();
	RzILOpEffect *op_ASSIGN_1 = SETL("j", LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")));
...
RzILOpEffect *hex_il_op_a2_vcmpwgt(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_35 = LET("const_pos1ULL", DUP(const_pos1ULL), SHIFTL0(VARLP("const_pos1ULL"), VARL("j")));
	RzILOpPure *op_NOT_36 = LOGNOT(op_LSHIFT_35);
	RzILOpPure *op_AND_37 = LOGAND(VARG(Pd_assoc_tmp), op_NOT_36);
	RzILOpPure *op_MUL_38 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_39 = SHIFTR0(DUP(Rss), op_MUL_38);
	RzILOpPure *op_AND_40 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_39, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_41 = CAST(32, MSB(op_AND_40), op_AND_40);
	RzILOpPure *cast_st64_42 = CAST(64, MSB(cast_st32_41), cast_st32_41);
	RzILOpPure *op_MUL_43 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_GT_48 = SGT(cast_st64_42, cast_st64_47);
...
RzILOpEffect *hex_il_op_a2_vconj(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_20 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_21 = SHIFTR0(DUP(Rss), op_MUL_20);
	RzILOpPure *op_AND_22 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_21, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_44 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_45 = SHIFTR0(DUP(Rss), op_MUL_44);
	RzILOpPure *op_AND_46 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_45, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_47 = CAST(32, IL_FALSE, op_AND_46);
	RzILOpPure *op_NEG_48 = NEG(cast_st16_47);
	RzILOpPure *op_LT_49 = LET("const_pos0", DUP(const_pos0), ULT(op_NEG_48, VARLP("const_pos0")));
	RzILOpPure *op_SUB_50 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_53 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_54 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_53));
	RzILOpPure *op_SUB_55 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_54, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_60 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_LSHIFT_66 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_65));
	...
	RzILOpPure *op_RSHIFT_70 = SHIFTR0(DUP(Rss), op_MUL_69);
	RzILOpPure *op_AND_71 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_70, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_72 = CAST(32, IL_FALSE, op_AND_71);
	RzILOpPure *op_AND_73 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cast_st16_72, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_74 = CAST(64, IL_FALSE, op_AND_73);
	RzILOpPure *op_MUL_75 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_76 = SHIFTL0(cast_ut64_74, op_MUL_75);
	RzILOpPure *op_OR_77 = LOGOR(op_AND_68, op_LSHIFT_76);
	RzILOpPure *op_MUL_80 = LET("const_pos3", const_pos3, LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_81 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_80));
	...
	RzILOpPure *op_MUL_85 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	...
	RzILOpPure *cond_93 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_84, VARL("h_tmp5"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_94 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_95 = SHIFTR0(DUP(Rss), op_MUL_94);
	RzILOpPure *op_AND_96 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_95, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_100 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_101 = SHIFTR0(DUP(Rss), op_MUL_100);
	RzILOpPure *op_AND_102 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_101, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_124 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_LT_129 = LET("const_pos0", DUP(const_pos0), ULT(op_NEG_128, VARLP("const_pos0")));
	RzILOpPure *op_SUB_130 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_133 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_134 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_133));
	RzILOpPure *op_SUB_135 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_134, VARLP("const_pos1")));
	RzILOpPure *cond_136 = ITE(op_LT_129, op_NEG_132, op_SUB_135);
	RzILOpPure *cond_137 = ITE(op_EQ_99, op_NEG_104, cond_136);
	RzILOpPure *op_AND_138 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_137, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_139 = CAST(64, IL_FALSE, op_AND_138);
	RzILOpPure *op_MUL_140 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_141 = SHIFTL0(cast_ut64_139, op_MUL_140);
	RzILOpPure *op_OR_142 = LOGOR(op_AND_83, op_LSHIFT_141);
	RzILOpPure *op_MUL_145 = LET("const_pos2", const_pos2, LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_146 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_145));
	RzILOpPure *op_NOT_147 = LOGNOT(op_LSHIFT_146);
	RzILOpPure *op_AND_148 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_147);
	RzILOpPure *op_MUL_149 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_150 = SHIFTR0(DUP(Rss), op_MUL_149);
	RzILOpPure *op_AND_151 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_150, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_152 = CAST(32, IL_FALSE, op_AND_151);
	RzILOpPure *op_AND_153 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cast_st16_152, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_154 = CAST(64, IL_FALSE, op_AND_153);
	RzILOpPure *op_MUL_155 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_156 = SHIFTL0(cast_ut64_154, op_MUL_155);
	RzILOpPure *op_OR_157 = LOGOR(op_AND_148, op_LSHIFT_156);

	// WRITE
	RzILOpEffect *c_call_10 = HEX_SEXTRACT64(op_NEG_9, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_11 = SETL("h_tmp0", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_12 = SEQN(2, c_call_10, op_ASSIGN_hybrid_tmp_11);
	...
	RzILOpEffect *seq_35 = SEQN(2, c_call_33, op_ASSIGN_hybrid_tmp_34);
	RzILOpEffect *seq_36 = SEQN(2, seq_32, seq_35);
	RzILOpEffect *c_call_37 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_90 = HEX_SEXTRACT64(op_NEG_89, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_117 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp7"), VARL("h_tmp8"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_vmaxb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_19 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_20 = SHIFTR0(DUP(Rtt), op_MUL_19);
	RzILOpPure *op_AND_21 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_20, VARLP("const_pos0xff")));
	RzILOpPure *cast_st8_22 = CAST(64, IL_FALSE, op_AND_21);
	RzILOpPure *op_MUL_23 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_24 = SHIFTR0(DUP(Rss), op_MUL_23);
	RzILOpPure *op_AND_25 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_24, VARLP("const_pos0xff")));
	RzILOpPure *cast_st8_26 = CAST(8, MSB(op_AND_25), op_AND_25);
	RzILOpPure *cond_27 = ITE(op_GT_18, cast_st8_22, cast_st8_26);
	RzILOpPure *op_AND_28 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cond_27, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_29 = CAST(64, IL_FALSE, op_AND_28);
	RzILOpPure *op_MUL_30 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_a2_vmaxh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st16_17 = CAST(16, MSB(op_AND_16), op_AND_16);
	RzILOpPure *op_GT_18 = SGT(cast_st16_13, cast_st16_17);
	RzILOpPure *op_MUL_19 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_20 = SHIFTR0(DUP(Rtt), op_MUL_19);
	...
	RzILOpPure *cast_ut64_29 = CAST(64, IL_FALSE, op_AND_28);
	RzILOpPure *op_MUL_30 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_31 = SHIFTL0(cast_ut64_29, op_MUL_30);
	RzILOpPure *op_OR_32 = LOGOR(op_AND_9, op_LSHIFT_31);
...
RzILOpEffect *hex_il_op_a2_vmaxuw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_26 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *op_AND_32 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_31, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_33 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vnavghcr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_EQ_21 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_20, VARLP("const_pos0x3")));
	RzILOpPure *op_MUL_22 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_26 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_27 = SHIFTR0(DUP(Rss), op_MUL_26);
	RzILOpPure *op_AND_28 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_27, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_32 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_33 = SHIFTR0(DUP(Rtt), op_MUL_32);
	...
	RzILOpPure *op_RSHIFT_42 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_41, VARLP("const_pos1")));
	...
	RzILOpPure *op_AND_57 = LET("const_pos0x3", DUP(const_pos0x3), LOGAND(op_SUB_56, VARLP("const_pos0x3")));
	RzILOpPure *op_EQ_58 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_57, VARLP("const_pos0x3")));
	...
	RzILOpPure *op_ADD_68 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_67, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_73 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_74 = SHIFTR0(DUP(Rss), op_MUL_73);
	RzILOpPure *op_AND_75 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_74, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_RSHIFT_79 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_78, VARLP("const_pos1")));
	RzILOpPure *op_EQ_80 = EQ(cond_47, op_RSHIFT_79);
	RzILOpPure *op_MUL_81 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_82 = SHIFTR0(DUP(Rtt), op_MUL_81);
	RzILOpPure *op_AND_83 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_82, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_84 = CAST(32, IL_FALSE, op_AND_83);
	RzILOpPure *op_MUL_85 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_86 = SHIFTR0(DUP(Rss), op_MUL_85);
	RzILOpPure *op_AND_87 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_86, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_88 = CAST(16, MSB(op_AND_87), op_AND_87);
	RzILOpPure *op_SUB_89 = SUB(cast_st16_84, cast_st16_88);
	RzILOpPure *op_AND_90 = LET("const_pos0x3", DUP(const_pos0x3), LOGAND(op_SUB_89, VARLP("const_pos0x3")));
	RzILOpPure *op_EQ_91 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_90, VARLP("const_pos0x3")));
	RzILOpPure *op_MUL_92 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_96 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_97 = SHIFTR0(DUP(Rss), op_MUL_96);
	RzILOpPure *op_AND_98 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_97, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_99 = CAST(16, MSB(op_AND_98), op_AND_98);
	RzILOpPure *op_SUB_100 = SUB(cast_st16_95, cast_st16_99);
	RzILOpPure *op_ADD_101 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_100, VARLP("const_pos1")));
	RzILOpPure *op_MUL_102 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_106 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_107 = SHIFTR0(DUP(Rss), op_MUL_106);
	RzILOpPure *op_AND_108 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_107, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_RSHIFT_112 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_111, VARLP("const_pos1")));
	RzILOpPure *cond_129 = ITE(VARL("h_tmp2"), VARL("h_tmp5"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_132 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_136 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_137 = SHIFTR0(DUP(Rss), op_MUL_136);
	RzILOpPure *op_AND_138 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_137, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_139 = CAST(16, MSB(op_AND_138), op_AND_138);
	RzILOpPure *op_SUB_140 = SUB(cast_st16_135, cast_st16_139);
	RzILOpPure *op_AND_141 = LET("const_pos0x3", DUP(const_pos0x3), LOGAND(op_SUB_140, VARLP("const_pos0x3")));
	RzILOpPure *op_EQ_142 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_141, VARLP("const_pos0x3")));
	RzILOpPure *op_MUL_143 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_144 = SHIFTR0(DUP(Rtt), op_MUL_143);
	RzILOpPure *op_AND_145 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_144, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_146 = CAST(32, IL_FALSE, op_AND_145);
	RzILOpPure *op_MUL_147 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_148 = SHIFTR0(DUP(Rss), op_MUL_147);
	RzILOpPure *op_AND_149 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_148, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_150 = CAST(16, MSB(op_AND_149), op_AND_149);
	RzILOpPure *op_SUB_151 = SUB(cast_st16_146, cast_st16_150);
	RzILOpPure *op_ADD_152 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_151, VARLP("const_pos1")));
	RzILOpPure *op_MUL_153 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_154 = SHIFTR0(DUP(Rtt), op_MUL_153);
	RzILOpPure *op_AND_155 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_154, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_156 = CAST(16, MSB(op_AND_155), op_AND_155);
	RzILOpPure *op_MUL_157 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_158 = SHIFTR0(DUP(Rss), op_MUL_157);
	RzILOpPure *op_AND_159 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_158, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_RSHIFT_163 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_162, VARLP("const_pos1")));
	RzILOpPure *op_LT_164 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_163, VARLP("const_pos0")));
	RzILOpPure *op_SUB_165 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_168 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_169 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_168));
	RzILOpPure *op_SUB_170 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_169, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_175 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_43 = HEX_SEXTRACT64(op_RSHIFT_42, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_125 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_a2_vnavghr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_21 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_20, VARLP("const_pos1")));
	RzILOpPure *cond_26 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_10, VARL("h_tmp1"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_27 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_28 = SHIFTR0(DUP(Rtt), op_MUL_27);
	RzILOpPure *op_AND_29 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_28, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_ADD_36 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_35, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_37 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_36, VARLP("const_pos1")));
	RzILOpPure *op_EQ_38 = EQ(cond_26, op_RSHIFT_37);
	RzILOpPure *op_MUL_39 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_40 = SHIFTR0(DUP(Rtt), op_MUL_39);
	RzILOpPure *op_AND_41 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_40, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_42 = CAST(32, IL_FALSE, op_AND_41);
	RzILOpPure *op_MUL_43 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_44 = SHIFTR0(DUP(Rss), op_MUL_43);
	RzILOpPure *op_AND_45 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_44, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_46 = CAST(16, MSB(op_AND_45), op_AND_45);
	RzILOpPure *op_SUB_47 = SUB(cast_st16_42, cast_st16_46);
	RzILOpPure *op_ADD_48 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_47, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_49 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_48, VARLP("const_pos1")));
	RzILOpPure *cond_66 = ITE(VARL("h_tmp2"), VARL("h_tmp5"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_69 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_70 = SHIFTR0(DUP(Rtt), op_MUL_69);
	RzILOpPure *op_AND_71 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_70, VARLP("const_pos0xffff")));
	...
	RzILOpPure *cast_st16_76 = CAST(16, MSB(op_AND_75), op_AND_75);
	RzILOpPure *op_SUB_77 = SUB(cast_st16_72, cast_st16_76);
	RzILOpPure *op_ADD_78 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_77, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_79 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_78, VARLP("const_pos1")));
	RzILOpPure *op_LT_80 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_79, VARLP("const_pos0")));
	...
	RzILOpPure *op_LSHIFT_82 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_81));
	RzILOpPure *op_NEG_83 = NEG(op_LSHIFT_82);
	RzILOpPure *op_SUB_84 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_85 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_84));
	RzILOpPure *op_SUB_86 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_85, VARLP("const_pos1")));
	RzILOpPure *cond_87 = ITE(op_LT_80, op_NEG_83, op_SUB_86);
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_22 = HEX_SEXTRACT64(op_RSHIFT_21, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_a2_vnavgwcr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_9 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_8);
	RzILOpPure *op_NE_10 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_NE_11 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_12 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_13 = SHIFTR0(Rtt, op_MUL_12);
	RzILOpPure *op_AND_14 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_13, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_NE_22 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_23 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_24 = SHIFTR0(Rss, op_MUL_23);
	RzILOpPure *op_AND_25 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_24, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_26 = CAST(32, MSB(op_AND_25), op_AND_25);
	RzILOpPure *cast_st64_27 = CAST(64, MSB(cast_st32_26), cast_st32_26);
	RzILOpPure *cond_32 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_22, VARL("h_tmp2"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_EQ_35 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_34, VARLP("const_pos0x3")));
	RzILOpPure *op_NE_36 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_37 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_38 = SHIFTR0(DUP(Rtt), op_MUL_37);
	RzILOpPure *op_AND_39 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_38, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_40 = CAST(32, MSB(op_AND_39), op_AND_39);
	RzILOpPure *cast_st64_41 = CAST(64, MSB(cast_st32_40), cast_st32_40);
	RzILOpPure *cond_46 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_36, VARL("h_tmp3"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_47 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_48 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_57 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_47, VARL("h_tmp4"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_61 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_70 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_60, VARL("h_tmp5"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_72 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_73 = SHIFTR0(DUP(Rss), op_MUL_72);
	RzILOpPure *op_AND_74 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_73, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_75 = CAST(32, MSB(op_AND_74), op_AND_74);
	RzILOpPure *cast_st64_76 = CAST(64, MSB(cast_st32_75), cast_st32_75);
	RzILOpPure *cond_81 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_71, VARL("h_tmp6"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_82 = SUB(cond_70, cond_81);
	RzILOpPure *cond_83 = ITE(op_EQ_35, op_ADD_59, op_SUB_82);
	RzILOpPure *op_RSHIFT_84 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_83, VARLP("const_pos1")));
	RzILOpPure *cond_89 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_10, VARL("h_tmp7"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_91 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_100 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_90, VARL("h_tmp8"), VARLP("const_pos0LL")));
	...
	RzILOpPure *cast_st32_105 = CAST(32, MSB(op_AND_104), op_AND_104);
	RzILOpPure *cast_st64_106 = CAST(64, MSB(cast_st32_105), cast_st32_105);
	RzILOpPure *cond_111 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_101, VARL("h_tmp9"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_112 = SUB(cond_100, cond_111);
	RzILOpPure *op_AND_113 = LET("const_pos0x3", DUP(const_pos0x3), LOGAND(op_SUB_112, VARLP("const_pos0x3")));
	RzILOpPure *op_EQ_114 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_113, VARLP("const_pos0x3")));
	RzILOpPure *op_NE_115 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_116 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_117 = SHIFTR0(DUP(Rtt), op_MUL_116);
	RzILOpPure *op_AND_118 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_117, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_125 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_115, VARL("h_tmp10"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_126 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_127 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_128 = SHIFTR0(DUP(Rss), op_MUL_127);
	RzILOpPure *op_AND_129 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_128, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_136 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_126, VARL("h_tmp11"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_137 = SUB(cond_125, cond_136);
	RzILOpPure *op_ADD_138 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_137, VARLP("const_pos1")));
	RzILOpPure *op_NE_139 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_140 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_141 = SHIFTR0(DUP(Rtt), op_MUL_140);
	RzILOpPure *op_AND_142 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_141, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_149 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_139, VARL("h_tmp12"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_150 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_151 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_160 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_150, VARL("h_tmp13"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_NE_165 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_166 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_167 = SHIFTR0(DUP(Rtt), op_MUL_166);
	RzILOpPure *op_AND_168 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_167, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_175 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_165, VARL("h_tmp14"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_176 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_177 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_178 = SHIFTR0(DUP(Rss), op_MUL_177);
	RzILOpPure *op_AND_179 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_178, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_186 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_176, VARL("h_tmp15"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_187 = SUB(cond_175, cond_186);
	RzILOpPure *op_AND_188 = LET("const_pos0x3", DUP(const_pos0x3), LOGAND(op_SUB_187, VARLP("const_pos0x3")));
	RzILOpPure *op_EQ_189 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_188, VARLP("const_pos0x3")));
	RzILOpPure *op_NE_190 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_191 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_200 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_190, VARL("h_tmp16"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_201 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_202 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_203 = SHIFTR0(DUP(Rss), op_MUL_202);
	RzILOpPure *op_AND_204 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_203, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_211 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_201, VARL("h_tmp17"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_212 = SUB(cond_200, cond_211);
	RzILOpPure *op_ADD_213 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_212, VARLP("const_pos1")));
	RzILOpPure *op_NE_214 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_215 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_216 = SHIFTR0(DUP(Rtt), op_MUL_215);
	RzILOpPure *op_AND_217 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_216, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_224 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_214, VARL("h_tmp18"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_226 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_227 = SHIFTR0(DUP(Rss), op_MUL_226);
	RzILOpPure *op_AND_228 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_227, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_235 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_225, VARL("h_tmp19"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_236 = SUB(cond_224, cond_235);
	RzILOpPure *cond_237 = ITE(op_EQ_189, op_ADD_213, op_SUB_236);
	RzILOpPure *op_RSHIFT_238 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_237, VARLP("const_pos1")));
	RzILOpPure *cond_255 = ITE(VARL("h_tmp20"), VARL("h_tmp23"), VARG(usr_assoc_tmp));
	RzILOpPure *op_NE_258 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_259 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_260 = SHIFTR0(DUP(Rtt), op_MUL_259);
	RzILOpPure *op_AND_261 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_260, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_267 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_258, VARL("h_tmp24"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_268 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_269 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_270 = SHIFTR0(DUP(Rss), op_MUL_269);
	RzILOpPure *op_AND_271 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_270, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_278 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_268, VARL("h_tmp25"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_279 = SUB(cond_267, cond_278);
	RzILOpPure *op_AND_280 = LET("const_pos0x3", DUP(const_pos0x3), LOGAND(op_SUB_279, VARLP("const_pos0x3")));
	RzILOpPure *op_EQ_281 = LET("const_pos0x3", DUP(const_pos0x3), EQ(op_AND_280, VARLP("const_pos0x3")));
	RzILOpPure *op_NE_282 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_283 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_284 = SHIFTR0(DUP(Rtt), op_MUL_283);
	RzILOpPure *op_AND_285 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_284, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_292 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_282, VARL("h_tmp26"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_294 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_295 = SHIFTR0(DUP(Rss), op_MUL_294);
	RzILOpPure *op_AND_296 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_295, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_303 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_293, VARL("h_tmp27"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_304 = SUB(cond_292, cond_303);
	RzILOpPure *op_ADD_305 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_304, VARLP("const_pos1")));
	RzILOpPure *op_NE_306 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_307 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_308 = SHIFTR0(DUP(Rtt), op_MUL_307);
	RzILOpPure *op_AND_309 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_308, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_316 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_306, VARL("h_tmp28"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_317 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_318 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_319 = SHIFTR0(DUP(Rss), op_MUL_318);
	RzILOpPure *op_AND_320 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_319, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_327 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_317, VARL("h_tmp29"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_328 = SUB(cond_316, cond_327);
	RzILOpPure *cond_329 = ITE(op_EQ_281, op_ADD_305, op_SUB_328);
	RzILOpPure *op_RSHIFT_330 = LET("const_pos1", DUP(const_pos1), SHIFTR0(cond_329, VARLP("const_pos1")));
	RzILOpPure *op_LT_331 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_330, VARLP("const_pos0")));
	RzILOpPure *op_SUB_332 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_335 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_336 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_335));
	RzILOpPure *op_SUB_337 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_336, VARLP("const_pos1")));
	RzILOpPure *cond_338 = ITE(op_LT_331, op_NEG_334, op_SUB_337);
	RzILOpPure *cond_340 = ITE(op_EQ_164, op_RSHIFT_238, cond_338);
	RzILOpPure *op_AND_341 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_340, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_342 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_17 = HEX_SEXTRACT64(cast_st64_16, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_28 = HEX_SEXTRACT64(cast_st64_27, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_42 = HEX_SEXTRACT64(cast_st64_41, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_53 = HEX_SEXTRACT64(cast_st64_52, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_66 = HEX_SEXTRACT64(cast_st64_65, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_67 = SETL("h_tmp5", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_68 = SEQN(2, c_call_66, op_ASSIGN_hybrid_tmp_67);
	RzILOpEffect *seq_69 = SEQN(2, seq_56, seq_68);
	RzILOpEffect *c_call_77 = HEX_SEXTRACT64(cast_st64_76, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_85 = HEX_SEXTRACT64(op_RSHIFT_84, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_96 = HEX_SEXTRACT64(cast_st64_95, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_107 = HEX_SEXTRACT64(cast_st64_106, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_121 = HEX_SEXTRACT64(cast_st64_120, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_122 = SETL("h_tmp10", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_123 = SEQN(2, c_call_121, op_ASSIGN_hybrid_tmp_122);
	RzILOpEffect *seq_124 = SEQN(2, seq_110, seq_123);
	RzILOpEffect *c_call_132 = HEX_SEXTRACT64(cast_st64_131, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_145 = HEX_SEXTRACT64(cast_st64_144, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_156 = HEX_SEXTRACT64(cast_st64_155, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_171 = HEX_SEXTRACT64(cast_st64_170, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_182 = HEX_SEXTRACT64(cast_st64_181, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_196 = HEX_SEXTRACT64(cast_st64_195, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_207 = HEX_SEXTRACT64(cast_st64_206, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_220 = HEX_SEXTRACT64(cast_st64_219, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_231 = HEX_SEXTRACT64(cast_st64_230, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_251 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp21"), VARL("h_tmp22"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_264 = HEX_SEXTRACT64(cast_st64_263, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_274 = HEX_SEXTRACT64(cast_st64_273, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_288 = HEX_SEXTRACT64(cast_st64_287, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_299 = HEX_SEXTRACT64(cast_st64_298, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_312 = HEX_SEXTRACT64(cast_st64_311, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_323 = HEX_SEXTRACT64(cast_st64_322, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vnavgwr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_35 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_34, VARLP("const_pos1")));
	RzILOpPure *cond_40 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_10, VARL("h_tmp3"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_41 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_42 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_43 = SHIFTR0(DUP(Rtt), op_MUL_42);
	RzILOpPure *op_AND_44 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_43, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_45 = CAST(32, MSB(op_AND_44), op_AND_44);
	RzILOpPure *cast_st64_46 = CAST(64, MSB(cast_st32_45), cast_st32_45);
	RzILOpPure *cond_51 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_41, VARL("h_tmp4"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_52 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_53 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_54 = SHIFTR0(DUP(Rss), op_MUL_53);
	RzILOpPure *op_AND_55 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_54, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_56 = CAST(32, MSB(op_AND_55), op_AND_55);
	RzILOpPure *cast_st64_57 = CAST(64, MSB(cast_st32_56), cast_st32_56);
	RzILOpPure *cond_62 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_52, VARL("h_tmp5"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_63 = SUB(cond_51, cond_62);
	RzILOpPure *op_ADD_64 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_63, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_65 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_64, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_68 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_77 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_67, VARL("h_tmp6"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_78 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_79 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_88 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_78, VARL("h_tmp7"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_89 = SUB(cond_77, cond_88);
	RzILOpPure *op_ADD_90 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_89, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_91 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_90, VARLP("const_pos1")));
	RzILOpPure *cond_108 = ITE(VARL("h_tmp8"), VARL("h_tmp11"), VARG(usr_assoc_tmp));
	RzILOpPure *op_NE_111 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_112 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpPure *cond_120 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_111, VARL("h_tmp12"), VARLP("const_pos0LL")));
	RzILOpPure *op_NE_121 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_122 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_123 = SHIFTR0(DUP(Rss), op_MUL_122);
	RzILOpPure *op_AND_124 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_123, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_131 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_121, VARL("h_tmp13"), VARLP("const_pos0LL")));
	RzILOpPure *op_SUB_132 = SUB(cond_120, cond_131);
	RzILOpPure *op_ADD_133 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_132, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_134 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_133, VARLP("const_pos1")));
	RzILOpPure *op_LT_135 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_134, VARLP("const_pos0")));
	...
	RzILOpPure *op_SUB_139 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_140 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_139));
	RzILOpPure *op_SUB_141 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_140, VARLP("const_pos1")));
	RzILOpPure *cond_142 = ITE(op_LT_135, op_NEG_138, op_SUB_141);
	RzILOpPure *cond_144 = ITE(op_EQ_66, op_RSHIFT_91, cond_142);
	RzILOpPure *op_AND_145 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_144, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_146 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *seq_30 = SEQN(2, c_call_28, op_ASSIGN_hybrid_tmp_29);
	RzILOpEffect *seq_31 = SEQN(2, seq_20, seq_30);
	RzILOpEffect *c_call_36 = HEX_SEXTRACT64(op_RSHIFT_35, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_47 = HEX_SEXTRACT64(cast_st64_46, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_58 = HEX_SEXTRACT64(cast_st64_57, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_59 = SETL("h_tmp5", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_60 = SEQN(2, c_call_58, op_ASSIGN_hybrid_tmp_59);
	RzILOpEffect *seq_61 = SEQN(2, seq_50, seq_60);
	RzILOpEffect *c_call_73 = HEX_SEXTRACT64(cast_st64_72, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_84 = HEX_SEXTRACT64(cast_st64_83, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_104 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp9"), VARL("h_tmp10"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_117 = HEX_SEXTRACT64(cast_st64_116, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_118 = SETL("h_tmp12", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_119 = SEQN(2, c_call_117, op_ASSIGN_hybrid_tmp_118);
	RzILOpEffect *c_call_127 = HEX_SEXTRACT64(cast_st64_126, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_a2_vraddub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_20 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_21 = SHIFTR0(Rtt, op_MUL_20);
	RzILOpPure *op_AND_22 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_21, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_AND_26 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_25, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_LT_36 = LET("const_pos8", DUP(const_pos8), ULT(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_MUL_40 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_41 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), SHIFTL0(VARLP("const_pos0x0ffffffffLL"), op_MUL_40));
	RzILOpPure *op_NOT_42 = LOGNOT(op_LSHIFT_41);
	RzILOpPure *op_AND_43 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_42);
	RzILOpPure *op_MUL_44 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_45 = SHIFTR0(VARG(Rdd_assoc_tmp), op_MUL_44);
	RzILOpPure *op_AND_46 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_45, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_47 = CAST(32, MSB(op_AND_46), op_AND_46);
	RzILOpPure *cast_st64_48 = CAST(64, IL_FALSE, cast_st32_47);
	RzILOpPure *op_MUL_49 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_50 = SHIFTR0(DUP(Rss), op_MUL_49);
	RzILOpPure *op_AND_51 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_50, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_52 = CAST(8, IL_FALSE, op_AND_51);
	RzILOpPure *op_MUL_53 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_54 = SHIFTR0(DUP(Rtt), op_MUL_53);
	RzILOpPure *op_AND_55 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_54, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_AND_59 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_58, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_60 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_61 = SHIFTL0(op_AND_59, op_MUL_60);
	RzILOpPure *op_OR_62 = LOGOR(op_AND_43, op_LSHIFT_61);

	// WRITE
	RzILOpEffect *empty_0 = EMPTY();
	RzILOpEffect *op_ASSIGN_1 = SETG(Rdd_assoc_tmp, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")));
	RzILOpEffect *op_ASSIGN_2 = SETL("i", LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")));
	...
	RzILOpEffect *op_ASSIGN_35 = SETL("i", LET("const_pos4", DUP(const_pos4), VARLP("const_pos4")));
...
RzILOpEffect *hex_il_op_a2_vraddub_acc(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_10 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_LT_35 = LET("const_pos8", DUP(const_pos8), ULT(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_MUL_39 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_40 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), SHIFTL0(VARLP("const_pos0x0ffffffffLL"), op_MUL_39));
	...
	RzILOpPure *op_MUL_48 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_49 = SHIFTR0(DUP(Rss), op_MUL_48);
	RzILOpPure *op_AND_50 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_49, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_51 = CAST(8, IL_FALSE, op_AND_50);
	RzILOpPure *op_MUL_52 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_53 = SHIFTR0(DUP(Rtt), op_MUL_52);
	RzILOpPure *op_AND_54 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_53, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_AND_58 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_57, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpEffect *op_ASSIGN_34 = SETL("i", LET("const_pos4", DUP(const_pos4), VARLP("const_pos4")));
...
RzILOpEffect *hex_il_op_a2_vrsadub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_25 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_24, VARLP("const_pos0")));
	RzILOpPure *op_MUL_26 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_27 = SHIFTR0(DUP(Rss), op_MUL_26);
	RzILOpPure *op_AND_28 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_27, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_29 = CAST(8, IL_FALSE, op_AND_28);
	RzILOpPure *op_MUL_30 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_31 = SHIFTR0(DUP(Rtt), op_MUL_30);
	RzILOpPure *op_AND_32 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_31, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_MUL_36 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_37 = SHIFTR0(DUP(Rss), op_MUL_36);
	RzILOpPure *op_AND_38 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_37, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_39 = CAST(8, IL_FALSE, op_AND_38);
	RzILOpPure *op_MUL_40 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_41 = SHIFTR0(DUP(Rtt), op_MUL_40);
	RzILOpPure *op_AND_42 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_41, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_AND_47 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_46, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_LT_57 = LET("const_pos8", DUP(const_pos8), ULT(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_MUL_61 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_62 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), SHIFTL0(VARLP("const_pos0x0ffffffffLL"), op_MUL_61));
	...
	RzILOpPure *op_MUL_70 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_71 = SHIFTR0(DUP(Rss), op_MUL_70);
	RzILOpPure *op_AND_72 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_71, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_73 = CAST(32, IL_FALSE, op_AND_72);
	RzILOpPure *op_MUL_74 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_75 = SHIFTR0(DUP(Rtt), op_MUL_74);
	RzILOpPure *op_AND_76 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_75, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_77 = CAST(8, IL_FALSE, op_AND_76);
	RzILOpPure *op_SUB_78 = SUB(cast_ut8_73, cast_ut8_77);
	RzILOpPure *op_LT_79 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_78, VARLP("const_pos0")));
	RzILOpPure *op_MUL_80 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpPure *op_MUL_84 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_85 = SHIFTR0(DUP(Rtt), op_MUL_84);
	RzILOpPure *op_AND_86 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_85, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_MUL_90 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_91 = SHIFTR0(DUP(Rss), op_MUL_90);
	RzILOpPure *op_AND_92 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_91, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_93 = CAST(8, IL_FALSE, op_AND_92);
	RzILOpPure *op_MUL_94 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_95 = SHIFTR0(DUP(Rtt), op_MUL_94);
	RzILOpPure *op_AND_96 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_95, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_AND_101 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_100, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpEffect *op_ASSIGN_56 = SETL("i", LET("const_pos4", DUP(const_pos4), VARLP("const_pos4")));
...
RzILOpEffect *hex_il_op_a2_vrsadub_acc(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_24 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_23, VARLP("const_pos0")));
	RzILOpPure *op_MUL_25 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_26 = SHIFTR0(DUP(Rss), op_MUL_25);
	RzILOpPure *op_AND_27 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_26, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_28 = CAST(8, IL_FALSE, op_AND_27);
	...
	RzILOpPure *op_AND_46 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_45, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_47 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_48 = SHIFTL0(op_AND_46, op_MUL_47);
	RzILOpPure *op_OR_49 = LOGOR(op_AND_9, op_LSHIFT_48);
	RzILOpPure *op_LT_56 = LET("const_pos8", DUP(const_pos8), ULT(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_MUL_60 = LET("const_pos1", const_pos1, LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_61 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), SHIFTL0(VARLP("const_pos0x0ffffffffLL"), op_MUL_60));
	RzILOpPure *op_NOT_62 = LOGNOT(op_LSHIFT_61);
	RzILOpPure *op_AND_63 = LOGAND(DUP(Rxx), op_NOT_62);
	RzILOpPure *op_MUL_64 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_MUL_69 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_70 = SHIFTR0(DUP(Rss), op_MUL_69);
	RzILOpPure *op_AND_71 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_70, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_72 = CAST(32, IL_FALSE, op_AND_71);
	RzILOpPure *op_MUL_73 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_74 = SHIFTR0(DUP(Rtt), op_MUL_73);
	RzILOpPure *op_AND_75 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_74, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_76 = CAST(8, IL_FALSE, op_AND_75);
	RzILOpPure *op_SUB_77 = SUB(cast_ut8_72, cast_ut8_76);
	RzILOpPure *op_LT_78 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_77, VARLP("const_pos0")));
	RzILOpPure *op_MUL_79 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_80 = SHIFTR0(DUP(Rss), op_MUL_79);
	RzILOpPure *op_AND_81 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_80, VARLP("const_pos0xff")));
	RzILOpPure *cast_ut8_82 = CAST(8, IL_FALSE, op_AND_81);
	RzILOpPure *op_MUL_83 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_84 = SHIFTR0(DUP(Rtt), op_MUL_83);
	RzILOpPure *op_AND_85 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_84, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_MUL_89 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpPure *op_MUL_93 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_94 = SHIFTR0(DUP(Rtt), op_MUL_93);
	RzILOpPure *op_AND_95 = LET("const_pos0xff", DUP(const_pos0xff), LOGAND(op_RSHIFT_94, VARLP("const_pos0xff")));
	...
	RzILOpPure *op_AND_100 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_ADD_99, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_101 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpEffect *op_ASSIGN_55 = SETL("i", LET("const_pos4", DUP(const_pos4), VARLP("const_pos4")));
...
RzILOpEffect *hex_il_op_a2_vsubub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_19 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(op_SUB_18, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_20 = CAST(64, IL_FALSE, op_AND_19);
	RzILOpPure *op_MUL_21 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	RzILOpPure *op_LSHIFT_22 = SHIFTL0(cast_ut64_20, op_MUL_21);
	RzILOpPure *op_OR_23 = LOGOR(op_AND_9, op_LSHIFT_22);
...
RzILOpEffect *hex_il_op_a2_vsububs(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_20 = HEX_EXTRACT64(op_SUB_19, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos8", DUP(const_pos8), VARLP("const_pos8")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_21 = SETL("h_tmp1", UNSIGNED(8, VARL("ret_val")));
	RzILOpEffect *seq_22 = SEQN(2, c_call_20, op_ASSIGN_hybrid_tmp_21);
	RzILOpEffect *seq_23 = SEQN(2, seq_5, seq_22);
	RzILOpEffect *c_call_44 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
...
RzILOpEffect *hex_il_op_a2_vsubw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_21 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_SUB_20, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_22 = LET("const_pos32", DUP(const_pos32), MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_LSHIFT_23 = SHIFTL0(op_AND_21, op_MUL_22);
	RzILOpPure *op_OR_24 = LOGOR(op_AND_9, op_LSHIFT_23);
...
RzILOpEffect *hex_il_op_a2_vsubws(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_80 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_79, VARLP("const_pos0")));
	RzILOpPure *op_SUB_81 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_82 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_81));
	RzILOpPure *op_NEG_83 = NEG(op_LSHIFT_82);
	RzILOpPure *op_SUB_84 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_22 = HEX_SEXTRACT64(op_SUB_21, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_23 = SETL("h_tmp1", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_24 = SEQN(2, c_call_22, op_ASSIGN_hybrid_tmp_23);
	RzILOpEffect *seq_25 = SEQN(2, seq_5, seq_24);
	RzILOpEffect *c_call_50 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
