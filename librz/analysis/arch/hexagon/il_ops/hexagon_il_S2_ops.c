...
RzILOpEffect *hex_il_op_s2_asl_i_vw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_16 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(op_LSHIFT_15, VARLP("const_pos0x0ffffffffLL")));
...
RzILOpEffect *hex_il_op_s2_asl_r_vh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_16 = LET("const_pos0", const_pos0, ULT(cond_15, VARLP("const_pos0")));
	RzILOpPure *op_MUL_17 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_NE_23 = LET("const_pos7", const_pos7, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos7"), VARLP("const_pos0")))));
	RzILOpPure *cond_28 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_23, VARL("h_tmp2"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_RSHIFT_32 = LET("const_pos1", const_pos1, SHIFTR0(op_RSHIFT_31, VARLP("const_pos1")));
	...
	RzILOpPure *op_NE_39 = LET("const_pos7", const_pos7, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos7"), VARLP("const_pos0")))));
	RzILOpPure *cond_44 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_39, VARL("h_tmp3"), VARLP("const_pos0LL")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_11 = HEX_SEXTRACT64(Rt, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	...
	RzILOpEffect *c_call_24 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	...
	RzILOpEffect *c_call_40 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
...
RzILOpEffect *hex_il_op_s2_asl_r_vw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NE_24 = LET("const_pos7", const_pos7, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos7"), VARLP("const_pos0")))));
	RzILOpPure *cond_29 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_24, VARL("h_tmp2"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_RSHIFT_33 = LET("const_pos1", const_pos1, SHIFTR0(op_RSHIFT_32, VARLP("const_pos1")));
	...
	RzILOpPure *op_NE_41 = LET("const_pos7", const_pos7, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos7"), VARLP("const_pos0")))));
	RzILOpPure *cond_46 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_41, VARL("h_tmp3"), VARLP("const_pos0LL")));
	RzILOpPure *op_LSHIFT_47 = SHIFTL0(cast_st64_40, cond_46);
	RzILOpPure *cond_48 = ITE(op_LT_16, op_RSHIFT_33, op_LSHIFT_47);
	RzILOpPure *op_AND_49 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(cond_48, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_50 = LET("const_pos32", const_pos32, MUL(VARL("i"), VARLP("const_pos32")));
	...
	RzILOpEffect *seq_13 = SEQN(2, c_call_11, op_ASSIGN_hybrid_tmp_12);
	RzILOpEffect *seq_14 = SEQN(2, seq_5, seq_13);
	RzILOpEffect *c_call_25 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	...
	RzILOpEffect *c_call_42 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
...
RzILOpEffect *hex_il_op_s2_asr_r_svw_trun(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_33 = LET("const_pos1", const_pos1, SHIFTL0(op_LSHIFT_32, VARLP("const_pos1")));
	RzILOpPure *op_MUL_34 = LET("const_pos32", const_pos32, MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_RSHIFT_35 = SHIFTR0(DUP(Rss), op_MUL_34);
	RzILOpPure *op_AND_36 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(op_RSHIFT_35, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_37 = CAST(32, MSB(op_AND_36), op_AND_36);
	...
	RzILOpPure *op_MUL_49 = LET("const_pos0", const_pos0, LET("const_pos16", const_pos16, MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
...
RzILOpEffect *hex_il_op_s2_asr_r_vh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LSHIFT_32 = LET("const_pos1", const_pos1, SHIFTL0(op_LSHIFT_31, VARLP("const_pos1")));
	RzILOpPure *op_MUL_33 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_34 = SHIFTR0(DUP(Rss), op_MUL_33);
	RzILOpPure *op_AND_35 = LET("const_pos0xffff", const_pos0xffff, LOGAND(op_RSHIFT_34, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_36 = CAST(16, MSB(op_AND_35), op_AND_35);
...
RzILOpEffect *hex_il_op_s2_clrbit_r(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_SUB_15 = LET("const_pos1", const_pos1, SUB(op_NEG_14, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_16 = SHIFTR0(cast_ut64_7, op_SUB_15);
	RzILOpPure *op_RSHIFT_17 = LET("const_pos1", const_pos1, SHIFTR0(op_RSHIFT_16, VARLP("const_pos1")));
	RzILOpPure *cast_ut32_18 = LET("const_pos1", const_pos1, CAST(32, IL_FALSE, VARLP("const_pos1")));
	RzILOpPure *cast_ut64_19 = CAST(64, IL_FALSE, cast_ut32_18);
	RzILOpPure *op_NE_20 = LET("const_pos7", const_pos7, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos7"), VARLP("const_pos0")))));
	RzILOpPure *cond_25 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_20, VARL("h_tmp2"), VARLP("const_pos0LL")));
	...
	// WRITE
	RzILOpEffect *c_call_1 = HEX_SEXTRACT64(Rt, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_2 = SETL("h_tmp0", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_3 = SEQN(2, c_call_1, op_ASSIGN_hybrid_tmp_2);
	RzILOpEffect *c_call_9 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_10 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_11 = SEQN(2, c_call_9, op_ASSIGN_hybrid_tmp_10);
	RzILOpEffect *seq_12 = SEQN(2, seq_3, seq_11);
	RzILOpEffect *c_call_21 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
...
RzILOpEffect *hex_il_op_s2_shuffeb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_11 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_MUL_12 = LET("const_pos8", const_pos8, MUL(op_MUL_11, VARLP("const_pos8")));
	...
	RzILOpPure *op_AND_16 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cast_st8_15, VARLP("const_pos0x0ffLL")));
	...
	RzILOpPure *op_MUL_19 = LET("const_pos8", const_pos8, MUL(op_MUL_18, VARLP("const_pos8")));
	...
	RzILOpPure *op_MUL_27 = LET("const_pos8", const_pos8, MUL(op_ADD_26, VARLP("const_pos8")));
	RzILOpPure *op_LSHIFT_28 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_27));
	RzILOpPure *op_NOT_29 = LOGNOT(op_LSHIFT_28);
	RzILOpPure *op_AND_30 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_29);
	RzILOpPure *op_MUL_31 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_MUL_32 = LET("const_pos8", const_pos8, MUL(op_MUL_31, VARLP("const_pos8")));
	...
	RzILOpPure *cast_st8_35 = CAST(64, MSB(op_AND_34), op_AND_34);
	RzILOpPure *op_AND_36 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cast_st8_35, VARLP("const_pos0x0ffLL")));
	...
	RzILOpPure *op_MUL_40 = LET("const_pos8", const_pos8, MUL(op_ADD_39, VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_s2_shuffeh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_10 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_9);
	RzILOpPure *op_MUL_11 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_MUL_12 = LET("const_pos16", const_pos16, MUL(op_MUL_11, VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_13 = SHIFTR0(Rtt, op_MUL_12);
	...
	RzILOpPure *cast_ut64_17 = CAST(64, IL_FALSE, op_AND_16);
	RzILOpPure *op_MUL_18 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_MUL_19 = LET("const_pos16", const_pos16, MUL(op_MUL_18, VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_20 = SHIFTL0(cast_ut64_17, op_MUL_19);
	RzILOpPure *op_OR_21 = LOGOR(op_AND_10, op_LSHIFT_20);
	RzILOpPure *op_MUL_25 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_26 = LET("const_pos1", const_pos1, ADD(op_MUL_25, VARLP("const_pos1")));
	RzILOpPure *op_MUL_27 = LET("const_pos16", const_pos16, MUL(op_ADD_26, VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_28 = LET("const_pos0x0ffffLL", const_pos0x0ffffLL, SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_27));
	RzILOpPure *op_NOT_29 = LOGNOT(op_LSHIFT_28);
	RzILOpPure *op_AND_30 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_29);
	RzILOpPure *op_MUL_31 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_MUL_32 = LET("const_pos16", const_pos16, MUL(op_MUL_31, VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_33 = SHIFTR0(Rss, op_MUL_32);
	...
	RzILOpPure *op_AND_36 = LET("const_pos0x0ffff", const_pos0x0ffff, LOGAND(cast_st16_35, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_37 = CAST(64, IL_FALSE, op_AND_36);
	RzILOpPure *op_MUL_38 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_39 = LET("const_pos1", const_pos1, ADD(op_MUL_38, VARLP("const_pos1")));
	RzILOpPure *op_MUL_40 = LET("const_pos16", const_pos16, MUL(op_ADD_39, VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_41 = SHIFTL0(cast_ut64_37, op_MUL_40);
	RzILOpPure *op_OR_42 = LOGOR(op_AND_30, op_LSHIFT_41);
...
RzILOpEffect *hex_il_op_s2_shuffob(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_13 = LET("const_pos8", const_pos8, MUL(op_ADD_12, VARLP("const_pos8")));
	...
	RzILOpPure *cast_st8_16 = CAST(64, MSB(op_AND_15), op_AND_15);
	RzILOpPure *op_AND_17 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cast_st8_16, VARLP("const_pos0x0ffLL")));
	...
	RzILOpPure *op_MUL_20 = LET("const_pos8", const_pos8, MUL(op_MUL_19, VARLP("const_pos8")));
	...
	RzILOpPure *op_LSHIFT_29 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_28));
	RzILOpPure *op_NOT_30 = LOGNOT(op_LSHIFT_29);
	RzILOpPure *op_AND_31 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_30);
	RzILOpPure *op_MUL_32 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_33 = LET("const_pos1", const_pos1, ADD(op_MUL_32, VARLP("const_pos1")));
	RzILOpPure *op_MUL_34 = LET("const_pos8", const_pos8, MUL(op_ADD_33, VARLP("const_pos8")));
	...
	RzILOpPure *cast_ut64_39 = CAST(64, IL_FALSE, op_AND_38);
	RzILOpPure *op_MUL_40 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_41 = LET("const_pos1", const_pos1, ADD(op_MUL_40, VARLP("const_pos1")));
	RzILOpPure *op_MUL_42 = LET("const_pos8", const_pos8, MUL(op_ADD_41, VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_s2_shuffoh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_11 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_12 = LET("const_pos1", const_pos1, ADD(op_MUL_11, VARLP("const_pos1")));
	RzILOpPure *op_MUL_13 = LET("const_pos16", const_pos16, MUL(op_ADD_12, VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_14 = SHIFTR0(Rss, op_MUL_13);
	...
	RzILOpPure *cast_ut64_18 = CAST(64, IL_FALSE, op_AND_17);
	RzILOpPure *op_MUL_19 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_MUL_20 = LET("const_pos16", const_pos16, MUL(op_MUL_19, VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_21 = SHIFTL0(cast_ut64_18, op_MUL_20);
	RzILOpPure *op_OR_22 = LOGOR(op_AND_10, op_LSHIFT_21);
	RzILOpPure *op_MUL_26 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_27 = LET("const_pos1", const_pos1, ADD(op_MUL_26, VARLP("const_pos1")));
	RzILOpPure *op_MUL_28 = LET("const_pos16", const_pos16, MUL(op_ADD_27, VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_29 = LET("const_pos0x0ffffLL", const_pos0x0ffffLL, SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_28));
	RzILOpPure *op_NOT_30 = LOGNOT(op_LSHIFT_29);
	RzILOpPure *op_AND_31 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_30);
	RzILOpPure *op_MUL_32 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_33 = LET("const_pos1", const_pos1, ADD(op_MUL_32, VARLP("const_pos1")));
	RzILOpPure *op_MUL_34 = LET("const_pos16", const_pos16, MUL(op_ADD_33, VARLP("const_pos16")));
	RzILOpPure *op_RSHIFT_35 = SHIFTR0(Rtt, op_MUL_34);
	RzILOpPure *op_AND_36 = LET("const_pos0xffff", const_pos0xffff, LOGAND(op_RSHIFT_35, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_37 = CAST(32, IL_FALSE, op_AND_36);
	RzILOpPure *op_AND_38 = LET("const_pos0x0ffff", const_pos0x0ffff, LOGAND(cast_st16_37, VARLP("const_pos0x0ffff")));
	...
	RzILOpPure *op_MUL_40 = LET("const_pos2", const_pos2, MUL(VARL("i"), VARLP("const_pos2")));
	RzILOpPure *op_ADD_41 = LET("const_pos1", const_pos1, ADD(op_MUL_40, VARLP("const_pos1")));
	RzILOpPure *op_MUL_42 = LET("const_pos16", const_pos16, MUL(op_ADD_41, VARLP("const_pos16")));
	RzILOpPure *op_LSHIFT_43 = SHIFTL0(cast_ut64_39, op_MUL_42);
	RzILOpPure *op_OR_44 = LOGOR(op_AND_31, op_LSHIFT_43);
...
RzILOpEffect *hex_il_op_s2_svsathb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_13 = LET("const_pos0", const_pos0, LET("const_pos16", const_pos16, MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	...
	RzILOpPure *cast_st16_21 = CAST(64, MSB(op_AND_20), op_AND_20);
	...
	RzILOpPure *op_LT_45 = LET("const_pos0", const_pos0, ULT(cast_st16_44, VARLP("const_pos0")));
	RzILOpPure *op_SUB_46 = LET("const_pos8", const_pos8, LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_49 = LET("const_pos8", const_pos8, LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_AND_54 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cond_53, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_55 = CAST(64, IL_FALSE, op_AND_54);
	RzILOpPure *op_MUL_56 = LET("const_pos0", const_pos0, LET("const_pos8", const_pos8, MUL(VARLP("const_pos0"), VARLP("const_pos8"))));
	...
	RzILOpPure *op_LSHIFT_62 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_61));
	RzILOpPure *op_NOT_63 = LOGNOT(op_LSHIFT_62);
	RzILOpPure *op_AND_64 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_63);
	RzILOpPure *op_NE_65 = LET("const_pos8", const_pos8, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos8"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_73 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_65, VARL("h_tmp5"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_AND_76 = LET("const_pos0xffff", const_pos0xffff, LOGAND(op_RSHIFT_75, VARLP("const_pos0xffff")));
	...
	RzILOpPure *cast_st16_82 = CAST(64, MSB(op_AND_81), op_AND_81);
	RzILOpPure *cond_99 = ITE(VARL("h_tmp6"), VARL("h_tmp9"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_102 = LET("const_pos1", const_pos1, LET("const_pos16", const_pos16, MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_LT_106 = LET("const_pos0", const_pos0, ULT(cast_st16_105, VARLP("const_pos0")));
	RzILOpPure *op_SUB_107 = LET("const_pos8", const_pos8, LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_108 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_107));
	RzILOpPure *op_NEG_109 = NEG(op_LSHIFT_108);
	RzILOpPure *op_SUB_110 = LET("const_pos8", const_pos8, LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_111 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_110));
	RzILOpPure *op_SUB_112 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_111, VARLP("const_pos1")));
	RzILOpPure *cond_113 = ITE(op_LT_106, op_NEG_109, op_SUB_112);
	RzILOpPure *cond_114 = ITE(op_EQ_78, cast_st16_82, cond_113);
	RzILOpPure *op_AND_115 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cond_114, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_116 = CAST(64, IL_FALSE, op_AND_115);
	RzILOpPure *op_MUL_117 = LET("const_pos1", const_pos1, LET("const_pos8", const_pos8, MUL(VARLP("const_pos1"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_118 = SHIFTL0(cast_ut64_116, op_MUL_117);
	RzILOpPure *op_OR_119 = LOGOR(op_AND_64, op_LSHIFT_118);
	RzILOpPure *op_MUL_122 = LET("const_pos2", const_pos2, LET("const_pos8", const_pos8, MUL(VARLP("const_pos2"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_123 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_122));
	RzILOpPure *op_NOT_124 = LOGNOT(op_LSHIFT_123);
	RzILOpPure *op_AND_125 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_124);
	RzILOpPure *op_AND_126 = LET("const_pos0", const_pos0, LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(VARLP("const_pos0"), VARLP("const_pos0x0ffLL"))));
	RzILOpPure *cast_ut64_127 = CAST(64, IL_FALSE, op_AND_126);
	RzILOpPure *op_MUL_128 = LET("const_pos2", const_pos2, LET("const_pos8", const_pos8, MUL(VARLP("const_pos2"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_129 = SHIFTL0(cast_ut64_127, op_MUL_128);
	RzILOpPure *op_OR_130 = LOGOR(op_AND_125, op_LSHIFT_129);
	RzILOpPure *op_MUL_133 = LET("const_pos3", const_pos3, LET("const_pos8", const_pos8, MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_134 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_133));
	RzILOpPure *op_NOT_135 = LOGNOT(op_LSHIFT_134);
	RzILOpPure *op_AND_136 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_135);
	RzILOpPure *op_AND_137 = LET("const_pos0", const_pos0, LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(VARLP("const_pos0"), VARLP("const_pos0x0ffLL"))));
	RzILOpPure *cast_ut64_138 = CAST(64, IL_FALSE, op_AND_137);
	RzILOpPure *op_MUL_139 = LET("const_pos3", const_pos3, LET("const_pos8", const_pos8, MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_140 = SHIFTL0(cast_ut64_138, op_MUL_139);
	RzILOpPure *op_OR_141 = LOGOR(op_AND_136, op_LSHIFT_140);

	// WRITE
	RzILOpEffect *c_call_9 = HEX_SEXTRACT64(cast_st16_8, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos8", const_pos8, VARLP("const_pos8")));
	...
	RzILOpEffect *c_call_34 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
	...
	RzILOpEffect *empty_60 = EMPTY();
	RzILOpEffect *c_call_70 = HEX_SEXTRACT64(cast_st16_69, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos8", const_pos8, VARLP("const_pos8")));
	...
	RzILOpEffect *c_call_95 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp7"), VARL("h_tmp8"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s2_svsathub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st16_44 = CAST(32, IL_FALSE, op_AND_43);
	RzILOpPure *op_LT_45 = LET("const_pos0", const_pos0, ULT(cast_st16_44, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_46 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", const_pos8, SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	RzILOpPure *op_SUB_47 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_46, VARLP("const_pos1")));
	RzILOpPure *cond_48 = LET("const_pos0", const_pos0, ITE(op_LT_45, VARLP("const_pos0"), op_SUB_47));
	RzILOpPure *cond_49 = ITE(op_EQ_17, cast_st16_21, cond_48);
	RzILOpPure *op_AND_50 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cond_49, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_51 = CAST(64, IL_FALSE, op_AND_50);
	RzILOpPure *op_MUL_52 = LET("const_pos0", const_pos0, LET("const_pos8", const_pos8, MUL(VARLP("const_pos0"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_53 = SHIFTL0(cast_ut64_51, op_MUL_52);
	RzILOpPure *op_OR_54 = LOGOR(op_AND_3, op_LSHIFT_53);
	RzILOpPure *op_MUL_57 = LET("const_pos1", const_pos1, LET("const_pos8", const_pos8, MUL(VARLP("const_pos1"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_58 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_57));
	RzILOpPure *op_NOT_59 = LOGNOT(op_LSHIFT_58);
	RzILOpPure *op_AND_60 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_59);
	RzILOpPure *op_NE_61 = LET("const_pos8", const_pos8, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos8"), VARLP("const_pos0")))));
	...
	RzILOpPure *cond_69 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_61, VARL("h_tmp5"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_MUL_75 = LET("const_pos1", const_pos1, LET("const_pos16", const_pos16, MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *cast_st16_78 = CAST(64, MSB(op_AND_77), op_AND_77);
	RzILOpPure *cond_95 = ITE(VARL("h_tmp6"), VARL("h_tmp9"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_98 = LET("const_pos1", const_pos1, LET("const_pos16", const_pos16, MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *cast_st16_101 = CAST(32, IL_FALSE, op_AND_100);
	RzILOpPure *op_LT_102 = LET("const_pos0", const_pos0, ULT(cast_st16_101, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_103 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", const_pos8, SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	RzILOpPure *op_SUB_104 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_103, VARLP("const_pos1")));
	RzILOpPure *cond_105 = LET("const_pos0", const_pos0, ITE(op_LT_102, VARLP("const_pos0"), op_SUB_104));
	RzILOpPure *cond_106 = ITE(op_EQ_74, cast_st16_78, cond_105);
	RzILOpPure *op_AND_107 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cond_106, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_108 = CAST(64, IL_FALSE, op_AND_107);
	RzILOpPure *op_MUL_109 = LET("const_pos1", const_pos1, LET("const_pos8", const_pos8, MUL(VARLP("const_pos1"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_110 = SHIFTL0(cast_ut64_108, op_MUL_109);
	RzILOpPure *op_OR_111 = LOGOR(op_AND_60, op_LSHIFT_110);
	RzILOpPure *op_MUL_114 = LET("const_pos2", const_pos2, LET("const_pos8", const_pos8, MUL(VARLP("const_pos2"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_115 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_114));
	RzILOpPure *op_NOT_116 = LOGNOT(op_LSHIFT_115);
	RzILOpPure *op_AND_117 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_116);
	RzILOpPure *op_AND_118 = LET("const_pos0", const_pos0, LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(VARLP("const_pos0"), VARLP("const_pos0x0ffLL"))));
	RzILOpPure *cast_ut64_119 = CAST(64, IL_FALSE, op_AND_118);
	RzILOpPure *op_MUL_120 = LET("const_pos2", const_pos2, LET("const_pos8", const_pos8, MUL(VARLP("const_pos2"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_121 = SHIFTL0(cast_ut64_119, op_MUL_120);
	RzILOpPure *op_OR_122 = LOGOR(op_AND_117, op_LSHIFT_121);
	RzILOpPure *op_MUL_125 = LET("const_pos3", const_pos3, LET("const_pos8", const_pos8, MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_126 = LET("const_pos0x0ffLL", const_pos0x0ffLL, SHIFTL0(VARLP("const_pos0x0ffLL"), op_MUL_125));
	RzILOpPure *op_NOT_127 = LOGNOT(op_LSHIFT_126);
	RzILOpPure *op_AND_128 = LOGAND(VARG(Rd_assoc_tmp), op_NOT_127);
	RzILOpPure *op_AND_129 = LET("const_pos0", const_pos0, LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(VARLP("const_pos0"), VARLP("const_pos0x0ffLL"))));
	RzILOpPure *cast_ut64_130 = CAST(64, IL_FALSE, op_AND_129);
	RzILOpPure *op_MUL_131 = LET("const_pos3", const_pos3, LET("const_pos8", const_pos8, MUL(VARLP("const_pos3"), VARLP("const_pos8"))));
	RzILOpPure *op_LSHIFT_132 = SHIFTL0(cast_ut64_130, op_MUL_131);
	RzILOpPure *op_OR_133 = LOGOR(op_AND_128, op_LSHIFT_132);

	// WRITE
	RzILOpEffect *c_call_9 = HEX_EXTRACT64(cast_st16_8, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos8", const_pos8, VARLP("const_pos8")));
	...
	RzILOpEffect *c_call_66 = HEX_EXTRACT64(cast_st16_65, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos8", const_pos8, VARLP("const_pos8")));
	...
	RzILOpEffect *seq_89 = SEQN(2, c_call_87, op_ASSIGN_hybrid_tmp_88);
	RzILOpEffect *seq_90 = SEQN(2, seq_86, seq_89);
	RzILOpEffect *c_call_91 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp7"), VARL("h_tmp8"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s2_tstbit_r(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NE_31 = LET("const_pos0", const_pos0, INV(EQ(op_AND_30, VARLP("const_pos0"))));
	...
	// WRITE
	RzILOpEffect *c_call_3 = HEX_SEXTRACT64(Rt, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	...
	RzILOpEffect *c_call_11 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_12 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
	RzILOpEffect *seq_13 = SEQN(2, c_call_11, op_ASSIGN_hybrid_tmp_12);
	RzILOpEffect *seq_14 = SEQN(2, seq_5, seq_13);
	RzILOpEffect *c_call_23 = HEX_SEXTRACT64(DUP(Rt), LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos7", const_pos7, VARLP("const_pos7")));
...
RzILOpEffect *hex_il_op_s2_vcnegh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_NE_12 = LET("const_pos16", const_pos16, LET("const_pos0", const_pos0, INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	...
	RzILOpPure *op_MUL_53 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_LT_58 = LET("const_pos0", const_pos0, ULT(op_NEG_57, VARLP("const_pos0")));
	...
	RzILOpPure *op_MUL_74 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_MUL_78 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_AND_82 = LET("const_pos0x0ffff", const_pos0x0ffff, LOGAND(cast_st16_81, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_83 = CAST(64, IL_FALSE, op_AND_82);
	RzILOpPure *op_MUL_84 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_18 = HEX_SEXTRACT64(op_NEG_17, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos16", const_pos16, VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_46 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s2_vrndpackwhs(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_27 = LET("const_pos0x08000", const_pos0x08000, ADD(cast_st64_26, VARLP("const_pos0x08000")));
	...
	RzILOpPure *op_ADD_34 = LET("const_pos0x08000", const_pos0x08000, ADD(cast_st64_33, VARLP("const_pos0x08000")));
	...
	RzILOpPure *op_ADD_59 = LET("const_pos0x08000", const_pos0x08000, ADD(cast_st64_58, VARLP("const_pos0x08000")));
	RzILOpPure *op_LT_60 = LET("const_pos0", const_pos0, ULT(op_ADD_59, VARLP("const_pos0")));
	RzILOpPure *op_SUB_61 = LET("const_pos32", const_pos32, LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_64 = LET("const_pos32", const_pos32, LET("const_pos1", const_pos1, SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_65 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_64));
	...
	RzILOpPure *op_MUL_69 = LET("const_pos1", const_pos1, LET("const_pos16", const_pos16, MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_MUL_75 = LET("const_pos16", const_pos16, MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_17 = HEX_SEXTRACT64(op_ADD_16, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos32", const_pos32, VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_47 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s2_vsathb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st16_28 = CAST(64, MSB(op_AND_27), op_AND_27);
	...
	RzILOpPure *op_LT_52 = LET("const_pos0", const_pos0, ULT(cast_st16_51, VARLP("const_pos0")));
	RzILOpPure *op_SUB_53 = LET("const_pos8", const_pos8, LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_56 = LET("const_pos8", const_pos8, LET("const_pos1", const_pos1, SUB(VARLP("const_pos8"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_57 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_56));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_15 = HEX_SEXTRACT64(cast_st16_14, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos8", const_pos8, VARLP("const_pos8")));
	...
	RzILOpEffect *c_call_41 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", const_pos1, VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s2_vsathub(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st16_51 = CAST(32, IL_FALSE, op_AND_50);
	RzILOpPure *op_LT_52 = LET("const_pos0", const_pos0, ULT(cast_st16_51, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_53 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", const_pos8, SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	RzILOpPure *op_SUB_54 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_53, VARLP("const_pos1")));
	RzILOpPure *cond_55 = LET("const_pos0", const_pos0, ITE(op_LT_52, VARLP("const_pos0"), op_SUB_54));
	RzILOpPure *cond_56 = ITE(op_EQ_24, cast_st16_28, cond_55);
	RzILOpPure *op_AND_57 = LET("const_pos0x0ffLL", const_pos0x0ffLL, LOGAND(cond_56, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_58 = CAST(64, IL_FALSE, op_AND_57);
	RzILOpPure *op_MUL_59 = LET("const_pos8", const_pos8, MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_15 = HEX_EXTRACT64(cast_st16_14, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos8", const_pos8, VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_s2_vsatwh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_56 = LET("const_pos0", const_pos0, ULT(cast_st64_55, VARLP("const_pos0")));
	RzILOpPure *op_SUB_57 = LET("const_pos16", const_pos16, LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_SUB_60 = LET("const_pos16", const_pos16, LET("const_pos1", const_pos1, SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_61 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_60));
	RzILOpPure *op_SUB_62 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_61, VARLP("const_pos1")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_16 = HEX_SEXTRACT64(cast_st64_15, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos16", const_pos16, VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_s2_vsatwh_nopack(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_63 = ITE(op_LT_56, op_NEG_59, op_SUB_62);
	RzILOpPure *cond_64 = ITE(op_EQ_26, cast_st64_31, cond_63);
	RzILOpPure *op_AND_65 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(cond_64, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_66 = LET("const_pos32", const_pos32, MUL(VARL("i"), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_s2_vsatwuh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st64_55 = CAST(32, IL_FALSE, cast_st32_54);
	RzILOpPure *op_LT_56 = LET("const_pos0", const_pos0, ULT(cast_st64_55, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_57 = LET("const_pos1LL", const_pos1LL, LET("const_pos16", const_pos16, SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos16"))));
	RzILOpPure *op_SUB_58 = LET("const_pos1", const_pos1, SUB(op_LSHIFT_57, VARLP("const_pos1")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_16 = HEX_EXTRACT64(cast_st64_15, LET("const_pos0", const_pos0, VARLP("const_pos0")), LET("const_pos16", const_pos16, VARLP("const_pos16")));
...
RzILOpEffect *hex_il_op_s2_vsatwuh_nopack(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_59 = LET("const_pos0", const_pos0, ITE(op_LT_56, VARLP("const_pos0"), op_SUB_58));
	RzILOpPure *cond_60 = ITE(op_EQ_26, cast_st64_31, cond_59);
	RzILOpPure *op_AND_61 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(cond_60, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_62 = LET("const_pos32", const_pos32, MUL(VARL("i"), VARLP("const_pos32")));
...
RzILOpEffect *hex_il_op_s2_vsxthw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_14 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(cast_st16_13, VARLP("const_pos0x0ffffffffLL")));
...
RzILOpEffect *hex_il_op_s2_vtrunehb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_11 = LET("const_pos8", const_pos8, MUL(op_MUL_10, VARLP("const_pos8")));
	RzILOpPure *op_RSHIFT_12 = SHIFTR0(Rss, op_MUL_11);
...
RzILOpEffect *hex_il_op_s2_vtrunohb(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_12 = LET("const_pos8", const_pos8, MUL(op_ADD_11, VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_s2_vzxthw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_14 = LET("const_pos0x0ffffffffLL", const_pos0x0ffffffffLL, LOGAND(cast_ut16_13, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_15 = LET("const_pos32", const_pos32, MUL(VARL("i"), VARLP("const_pos32")));
	RzILOpPure *op_LSHIFT_16 = SHIFTL0(op_AND_14, op_MUL_15);
	RzILOpPure *op_OR_17 = LOGOR(op_AND_9, op_LSHIFT_16);
