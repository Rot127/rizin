...
RzILOpEffect *hex_il_op_s4_ntstbit_r(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_EQ_31 = LET("const_pos0", DUP(const_pos0), EQ(op_AND_30, VARLP("const_pos0")));
...
RzILOpEffect *hex_il_op_s4_vxaddsubh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_AND_11 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_10, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_22 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_AND_62 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_61, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_63 = CAST(16, MSB(op_AND_62), op_AND_62);
	RzILOpPure *op_ADD_64 = ADD(cast_st16_59, cast_st16_63);
	RzILOpPure *op_LT_65 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_64, VARLP("const_pos0")));
	...
	RzILOpPure *op_LSHIFT_70 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_69));
	RzILOpPure *op_SUB_71 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_70, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_76 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_LSHIFT_82 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_81));
	RzILOpPure *op_NOT_83 = LOGNOT(op_LSHIFT_82);
	RzILOpPure *op_AND_84 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_83);
	RzILOpPure *op_NE_85 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_86 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_MUL_90 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_91 = SHIFTR0(DUP(Rtt), op_MUL_90);
	RzILOpPure *op_AND_92 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_91, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_93 = CAST(16, MSB(op_AND_92), op_AND_92);
	RzILOpPure *op_SUB_94 = SUB(cast_st16_89, cast_st16_93);
	RzILOpPure *cond_98 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_85, VARL("h_tmp5"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_99 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_100 = SHIFTR0(DUP(Rss), op_MUL_99);
	RzILOpPure *op_AND_101 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_100, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_102 = CAST(16, MSB(op_AND_101), op_AND_101);
	RzILOpPure *op_MUL_103 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_104 = SHIFTR0(DUP(Rtt), op_MUL_103);
	RzILOpPure *op_AND_105 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_104, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_109 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_110 = SHIFTR0(DUP(Rss), op_MUL_109);
	RzILOpPure *op_AND_111 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_110, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_AND_115 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_114, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_137 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_138 = SHIFTR0(DUP(Rss), op_MUL_137);
	RzILOpPure *op_AND_139 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_138, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_140 = CAST(32, IL_FALSE, op_AND_139);
	RzILOpPure *op_MUL_141 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_142 = SHIFTR0(DUP(Rtt), op_MUL_141);
	RzILOpPure *op_AND_143 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_142, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_144 = CAST(16, MSB(op_AND_143), op_AND_143);
	RzILOpPure *op_SUB_145 = SUB(cast_st16_140, cast_st16_144);
	RzILOpPure *op_LT_146 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_145, VARLP("const_pos0")));
	RzILOpPure *op_SUB_147 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_148 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_147));
	RzILOpPure *op_NEG_149 = NEG(op_LSHIFT_148);
	RzILOpPure *op_SUB_150 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_151 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_150));
	RzILOpPure *op_SUB_152 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_151, VARLP("const_pos1")));
	RzILOpPure *cond_153 = ITE(op_LT_146, op_NEG_149, op_SUB_152);
	RzILOpPure *cond_154 = ITE(op_EQ_108, op_SUB_117, cond_153);
	RzILOpPure *op_AND_155 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_154, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_156 = CAST(64, IL_FALSE, op_AND_155);
	RzILOpPure *op_MUL_157 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_158 = SHIFTL0(cast_ut64_156, op_MUL_157);
	RzILOpPure *op_OR_159 = LOGOR(op_AND_84, op_LSHIFT_158);
	RzILOpPure *op_MUL_162 = LET("const_pos2", const_pos2, LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_163 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_162));
	RzILOpPure *op_NOT_164 = LOGNOT(op_LSHIFT_163);
	RzILOpPure *op_AND_165 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_164);
	RzILOpPure *op_NE_166 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_167 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_168 = SHIFTR0(DUP(Rss), op_MUL_167);
	RzILOpPure *op_AND_169 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_168, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_170 = CAST(16, MSB(op_AND_169), op_AND_169);
	RzILOpPure *op_MUL_171 = LET("const_pos3", const_pos3, LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_172 = SHIFTR0(DUP(Rtt), op_MUL_171);
	RzILOpPure *op_AND_173 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_172, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_174 = CAST(16, MSB(op_AND_173), op_AND_173);
	RzILOpPure *op_ADD_175 = ADD(cast_st16_170, cast_st16_174);
	RzILOpPure *cond_179 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_166, VARL("h_tmp10"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_180 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_181 = SHIFTR0(DUP(Rss), op_MUL_180);
	RzILOpPure *op_AND_182 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_181, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_183 = CAST(16, MSB(op_AND_182), op_AND_182);
	RzILOpPure *op_MUL_184 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_185 = SHIFTR0(DUP(Rtt), op_MUL_184);
	RzILOpPure *op_AND_186 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_185, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_190 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_191 = SHIFTR0(DUP(Rss), op_MUL_190);
	RzILOpPure *op_AND_192 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_191, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_193 = CAST(32, IL_FALSE, op_AND_192);
	RzILOpPure *op_MUL_194 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_195 = SHIFTR0(DUP(Rtt), op_MUL_194);
	RzILOpPure *op_AND_196 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_195, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_218 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_219 = SHIFTR0(DUP(Rss), op_MUL_218);
	RzILOpPure *op_AND_220 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_219, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_221 = CAST(32, IL_FALSE, op_AND_220);
	RzILOpPure *op_MUL_222 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_223 = SHIFTR0(DUP(Rtt), op_MUL_222);
	RzILOpPure *op_AND_224 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_223, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_225 = CAST(16, MSB(op_AND_224), op_AND_224);
	RzILOpPure *op_ADD_226 = ADD(cast_st16_221, cast_st16_225);
	RzILOpPure *op_LT_227 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_226, VARLP("const_pos0")));
	RzILOpPure *op_SUB_228 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_229 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_228));
	RzILOpPure *op_NEG_230 = NEG(op_LSHIFT_229);
	RzILOpPure *op_SUB_231 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_232 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_231));
	RzILOpPure *op_SUB_233 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_232, VARLP("const_pos1")));
	RzILOpPure *cond_234 = ITE(op_LT_227, op_NEG_230, op_SUB_233);
	RzILOpPure *cond_235 = ITE(op_EQ_189, op_ADD_198, cond_234);
	RzILOpPure *op_AND_236 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_235, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_237 = CAST(64, IL_FALSE, op_AND_236);
	RzILOpPure *op_MUL_238 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_239 = SHIFTL0(cast_ut64_237, op_MUL_238);
	RzILOpPure *op_OR_240 = LOGOR(op_AND_165, op_LSHIFT_239);
	RzILOpPure *op_MUL_243 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_244 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_243));
	RzILOpPure *op_NOT_245 = LOGNOT(op_LSHIFT_244);
	RzILOpPure *op_AND_246 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_245);
	RzILOpPure *op_NE_247 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_248 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_249 = SHIFTR0(DUP(Rss), op_MUL_248);
	RzILOpPure *op_AND_250 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_249, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_251 = CAST(16, MSB(op_AND_250), op_AND_250);
	RzILOpPure *op_MUL_252 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_253 = SHIFTR0(DUP(Rtt), op_MUL_252);
	RzILOpPure *op_AND_254 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_253, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_255 = CAST(16, MSB(op_AND_254), op_AND_254);
	RzILOpPure *op_SUB_256 = SUB(cast_st16_251, cast_st16_255);
	RzILOpPure *cond_260 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_247, VARL("h_tmp15"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_261 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_262 = SHIFTR0(DUP(Rss), op_MUL_261);
	RzILOpPure *op_AND_263 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_262, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_264 = CAST(16, MSB(op_AND_263), op_AND_263);
	RzILOpPure *op_MUL_265 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_266 = SHIFTR0(DUP(Rtt), op_MUL_265);
	RzILOpPure *op_AND_267 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_266, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_271 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_272 = SHIFTR0(DUP(Rss), op_MUL_271);
	RzILOpPure *op_AND_273 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_272, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_AND_277 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_276, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_MUL_299 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_300 = SHIFTR0(DUP(Rss), op_MUL_299);
	RzILOpPure *op_AND_301 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_300, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_302 = CAST(32, IL_FALSE, op_AND_301);
	RzILOpPure *op_MUL_303 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_304 = SHIFTR0(DUP(Rtt), op_MUL_303);
	RzILOpPure *op_AND_305 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_304, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_306 = CAST(16, MSB(op_AND_305), op_AND_305);
	RzILOpPure *op_SUB_307 = SUB(cast_st16_302, cast_st16_306);
	RzILOpPure *op_LT_308 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_307, VARLP("const_pos0")));
	RzILOpPure *op_SUB_309 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_310 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_309));
	RzILOpPure *op_NEG_311 = NEG(op_LSHIFT_310);
	RzILOpPure *op_SUB_312 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_313 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_312));
	RzILOpPure *op_SUB_314 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_313, VARLP("const_pos1")));
	RzILOpPure *cond_315 = ITE(op_LT_308, op_NEG_311, op_SUB_314);
	RzILOpPure *cond_316 = ITE(op_EQ_270, op_SUB_279, cond_315);
	RzILOpPure *op_AND_317 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_316, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_318 = CAST(64, IL_FALSE, op_AND_317);
	RzILOpPure *op_MUL_319 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_320 = SHIFTL0(cast_ut64_318, op_MUL_319);
	RzILOpPure *op_OR_321 = LOGOR(op_AND_246, op_LSHIFT_320);

	// WRITE
	RzILOpEffect *c_call_14 = HEX_SEXTRACT64(op_ADD_13, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_49 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_95 = HEX_SEXTRACT64(op_SUB_94, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_130 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp7"), VARL("h_tmp8"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_176 = HEX_SEXTRACT64(op_ADD_175, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_211 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp12"), VARL("h_tmp13"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_257 = HEX_SEXTRACT64(op_SUB_256, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_292 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp17"), VARL("h_tmp18"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s4_vxaddsubhr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st16_12 = CAST(16, MSB(op_AND_11), op_AND_11);
	RzILOpPure *op_ADD_13 = ADD(cast_st16_8, cast_st16_12);
	RzILOpPure *op_ADD_14 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_13, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_15 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_14, VARLP("const_pos1")));
	RzILOpPure *cond_19 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_4, VARL("h_tmp0"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_20 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_ADD_29 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_28, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_30 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_29, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_36 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_ADD_41 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_40, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_42 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_41, VARLP("const_pos1")));
	...
	RzILOpPure *op_ADD_71 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_70, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_72 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_71, VARLP("const_pos1")));
	RzILOpPure *op_LT_73 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_72, VARLP("const_pos0")));
	...
	RzILOpPure *op_SUB_79 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_78, VARLP("const_pos1")));
	...
	RzILOpPure *op_MUL_89 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_90 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_89));
	RzILOpPure *op_NOT_91 = LOGNOT(op_LSHIFT_90);
	RzILOpPure *op_AND_92 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_91);
	RzILOpPure *op_NE_93 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_94 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	...
	RzILOpPure *op_ADD_103 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_102, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_104 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_103, VARLP("const_pos1")));
	RzILOpPure *cond_108 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_93, VARL("h_tmp5"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_109 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_110 = SHIFTR0(DUP(Rss), op_MUL_109);
	RzILOpPure *op_AND_111 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_110, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_112 = CAST(32, IL_FALSE, op_AND_111);
	...
	RzILOpPure *cast_st16_116 = CAST(16, MSB(op_AND_115), op_AND_115);
	RzILOpPure *op_SUB_117 = SUB(cast_st16_112, cast_st16_116);
	RzILOpPure *op_ADD_118 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_117, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_119 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_118, VARLP("const_pos1")));
	RzILOpPure *op_EQ_120 = EQ(cond_108, op_RSHIFT_119);
	RzILOpPure *op_MUL_121 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_122 = SHIFTR0(DUP(Rss), op_MUL_121);
	RzILOpPure *op_AND_123 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_122, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_124 = CAST(32, IL_FALSE, op_AND_123);
	RzILOpPure *op_MUL_125 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_126 = SHIFTR0(DUP(Rtt), op_MUL_125);
	RzILOpPure *op_AND_127 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_126, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_128 = CAST(16, MSB(op_AND_127), op_AND_127);
	RzILOpPure *op_SUB_129 = SUB(cast_st16_124, cast_st16_128);
	RzILOpPure *op_ADD_130 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_129, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_131 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_130, VARLP("const_pos1")));
	RzILOpPure *cond_148 = ITE(VARL("h_tmp6"), VARL("h_tmp9"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_151 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_152 = SHIFTR0(DUP(Rss), op_MUL_151);
	RzILOpPure *op_AND_153 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_152, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_154 = CAST(32, IL_FALSE, op_AND_153);
	RzILOpPure *op_MUL_155 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_156 = SHIFTR0(DUP(Rtt), op_MUL_155);
	RzILOpPure *op_AND_157 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_156, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_158 = CAST(16, MSB(op_AND_157), op_AND_157);
	RzILOpPure *op_SUB_159 = SUB(cast_st16_154, cast_st16_158);
	RzILOpPure *op_ADD_160 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_159, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_161 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_160, VARLP("const_pos1")));
	RzILOpPure *op_LT_162 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_161, VARLP("const_pos0")));
	...
	RzILOpPure *op_SUB_168 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_167, VARLP("const_pos1")));
	RzILOpPure *cond_169 = ITE(op_LT_162, op_NEG_165, op_SUB_168);
	RzILOpPure *cond_170 = ITE(op_EQ_120, op_RSHIFT_131, cond_169);
	RzILOpPure *op_AND_171 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_170, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_172 = CAST(64, IL_FALSE, op_AND_171);
	RzILOpPure *op_MUL_173 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_174 = SHIFTL0(cast_ut64_172, op_MUL_173);
	RzILOpPure *op_OR_175 = LOGOR(op_AND_92, op_LSHIFT_174);
	RzILOpPure *op_MUL_178 = LET("const_pos2", const_pos2, LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_179 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_178));
	RzILOpPure *op_NOT_180 = LOGNOT(op_LSHIFT_179);
	RzILOpPure *op_AND_181 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_180);
	RzILOpPure *op_NE_182 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_183 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_184 = SHIFTR0(DUP(Rss), op_MUL_183);
	RzILOpPure *op_AND_185 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_184, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_186 = CAST(32, IL_FALSE, op_AND_185);
	RzILOpPure *op_MUL_187 = LET("const_pos3", const_pos3, LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_188 = SHIFTR0(DUP(Rtt), op_MUL_187);
	RzILOpPure *op_AND_189 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_188, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_190 = CAST(16, MSB(op_AND_189), op_AND_189);
	RzILOpPure *op_ADD_191 = ADD(cast_st16_186, cast_st16_190);
	RzILOpPure *op_ADD_192 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_191, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_193 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_192, VARLP("const_pos1")));
	RzILOpPure *cond_197 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_182, VARL("h_tmp10"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_198 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_199 = SHIFTR0(DUP(Rss), op_MUL_198);
	RzILOpPure *op_AND_200 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_199, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_201 = CAST(32, IL_FALSE, op_AND_200);
	RzILOpPure *op_MUL_202 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_203 = SHIFTR0(DUP(Rtt), op_MUL_202);
	RzILOpPure *op_AND_204 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_203, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_205 = CAST(16, MSB(op_AND_204), op_AND_204);
	RzILOpPure *op_ADD_206 = ADD(cast_st16_201, cast_st16_205);
	RzILOpPure *op_ADD_207 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_206, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_208 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_207, VARLP("const_pos1")));
	...
	RzILOpPure *op_AND_212 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_211, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_213 = CAST(32, IL_FALSE, op_AND_212);
	RzILOpPure *op_MUL_214 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_215 = SHIFTR0(DUP(Rtt), op_MUL_214);
	RzILOpPure *op_AND_216 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_215, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_217 = CAST(16, MSB(op_AND_216), op_AND_216);
	RzILOpPure *op_ADD_218 = ADD(cast_st16_213, cast_st16_217);
	RzILOpPure *op_ADD_219 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_218, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_220 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_219, VARLP("const_pos1")));
	RzILOpPure *cond_237 = ITE(VARL("h_tmp11"), VARL("h_tmp14"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_240 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_241 = SHIFTR0(DUP(Rss), op_MUL_240);
	RzILOpPure *op_AND_242 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_241, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_243 = CAST(32, IL_FALSE, op_AND_242);
	RzILOpPure *op_MUL_244 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_245 = SHIFTR0(DUP(Rtt), op_MUL_244);
	RzILOpPure *op_AND_246 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_245, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_247 = CAST(16, MSB(op_AND_246), op_AND_246);
	RzILOpPure *op_ADD_248 = ADD(cast_st16_243, cast_st16_247);
	RzILOpPure *op_ADD_249 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_248, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_250 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_249, VARLP("const_pos1")));
	RzILOpPure *op_LT_251 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_250, VARLP("const_pos0")));
	RzILOpPure *op_SUB_252 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_253 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_252));
	RzILOpPure *op_NEG_254 = NEG(op_LSHIFT_253);
	RzILOpPure *op_SUB_255 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_256 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_255));
	RzILOpPure *op_SUB_257 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_256, VARLP("const_pos1")));
	RzILOpPure *cond_258 = ITE(op_LT_251, op_NEG_254, op_SUB_257);
	RzILOpPure *cond_259 = ITE(op_EQ_209, op_RSHIFT_220, cond_258);
	RzILOpPure *op_AND_260 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_259, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_261 = CAST(64, IL_FALSE, op_AND_260);
	RzILOpPure *op_MUL_262 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_263 = SHIFTL0(cast_ut64_261, op_MUL_262);
	RzILOpPure *op_OR_264 = LOGOR(op_AND_181, op_LSHIFT_263);
	RzILOpPure *op_MUL_267 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_268 = LET("const_pos0x0ffffLL", DUP(const_pos0x0ffffLL), SHIFTL0(VARLP("const_pos0x0ffffLL"), op_MUL_267));
	RzILOpPure *op_NOT_269 = LOGNOT(op_LSHIFT_268);
	RzILOpPure *op_AND_270 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_269);
	RzILOpPure *op_NE_271 = LET("const_pos16", DUP(const_pos16), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos16"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_272 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_273 = SHIFTR0(DUP(Rss), op_MUL_272);
	RzILOpPure *op_AND_274 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_273, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_275 = CAST(32, IL_FALSE, op_AND_274);
	RzILOpPure *op_MUL_276 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_277 = SHIFTR0(DUP(Rtt), op_MUL_276);
	RzILOpPure *op_AND_278 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_277, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_279 = CAST(16, MSB(op_AND_278), op_AND_278);
	RzILOpPure *op_SUB_280 = SUB(cast_st16_275, cast_st16_279);
	RzILOpPure *op_ADD_281 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_280, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_282 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_281, VARLP("const_pos1")));
	RzILOpPure *cond_286 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_271, VARL("h_tmp15"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_287 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_288 = SHIFTR0(DUP(Rss), op_MUL_287);
	RzILOpPure *op_AND_289 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_288, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_290 = CAST(32, IL_FALSE, op_AND_289);
	RzILOpPure *op_MUL_291 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_292 = SHIFTR0(DUP(Rtt), op_MUL_291);
	RzILOpPure *op_AND_293 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_292, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_294 = CAST(16, MSB(op_AND_293), op_AND_293);
	RzILOpPure *op_SUB_295 = SUB(cast_st16_290, cast_st16_294);
	RzILOpPure *op_ADD_296 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_295, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_297 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_296, VARLP("const_pos1")));
	...
	RzILOpPure *cast_st16_306 = CAST(16, MSB(op_AND_305), op_AND_305);
	RzILOpPure *op_SUB_307 = SUB(cast_st16_302, cast_st16_306);
	RzILOpPure *op_ADD_308 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_307, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_309 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_308, VARLP("const_pos1")));
	RzILOpPure *cond_326 = ITE(VARL("h_tmp16"), VARL("h_tmp19"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_329 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_330 = SHIFTR0(DUP(Rss), op_MUL_329);
	RzILOpPure *op_AND_331 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_330, VARLP("const_pos0xffff")));
	...
	RzILOpPure *op_AND_335 = LET("const_pos0xffff", DUP(const_pos0xffff), LOGAND(op_RSHIFT_334, VARLP("const_pos0xffff")));
	RzILOpPure *cast_st16_336 = CAST(16, MSB(op_AND_335), op_AND_335);
	RzILOpPure *op_SUB_337 = SUB(cast_st16_332, cast_st16_336);
	RzILOpPure *op_ADD_338 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_337, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_339 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_338, VARLP("const_pos1")));
	RzILOpPure *op_LT_340 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_339, VARLP("const_pos0")));
	RzILOpPure *op_SUB_341 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_342 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_341));
	RzILOpPure *op_NEG_343 = NEG(op_LSHIFT_342);
	RzILOpPure *op_SUB_344 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_345 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_344));
	RzILOpPure *op_SUB_346 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_345, VARLP("const_pos1")));
	RzILOpPure *cond_347 = ITE(op_LT_340, op_NEG_343, op_SUB_346);
	RzILOpPure *cond_348 = ITE(op_EQ_298, op_RSHIFT_309, cond_347);
	RzILOpPure *op_AND_349 = LET("const_pos0x0ffff", DUP(const_pos0x0ffff), LOGAND(cond_348, VARLP("const_pos0x0ffff")));
	RzILOpPure *cast_ut64_350 = CAST(64, IL_FALSE, op_AND_349);
	RzILOpPure *op_MUL_351 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_LSHIFT_352 = SHIFTL0(cast_ut64_350, op_MUL_351);
	RzILOpPure *op_OR_353 = LOGOR(op_AND_270, op_LSHIFT_352);

	// WRITE
	RzILOpEffect *c_call_16 = HEX_SEXTRACT64(op_RSHIFT_15, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_55 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp2"), VARL("h_tmp3"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_105 = HEX_SEXTRACT64(op_RSHIFT_104, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_144 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp7"), VARL("h_tmp8"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_194 = HEX_SEXTRACT64(op_RSHIFT_193, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_233 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp12"), VARL("h_tmp13"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
	...
	RzILOpEffect *c_call_283 = HEX_SEXTRACT64(op_RSHIFT_282, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	...
	RzILOpEffect *c_call_322 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp17"), VARL("h_tmp18"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s4_vxaddsubw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_19 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_4, VARL("h_tmp0"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_20 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_21 = SHIFTR0(DUP(Rss), op_MUL_20);
	...
	RzILOpPure *op_MUL_67 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_68 = SHIFTR0(DUP(Rtt), op_MUL_67);
	RzILOpPure *op_AND_69 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_68, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_LT_73 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_72, VARLP("const_pos0")));
	RzILOpPure *op_SUB_74 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_75 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_74));
	RzILOpPure *op_NEG_76 = NEG(op_LSHIFT_75);
	RzILOpPure *op_SUB_77 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_78 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_77));
	RzILOpPure *op_SUB_79 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_78, VARLP("const_pos1")));
	RzILOpPure *cond_80 = ITE(op_LT_73, op_NEG_76, op_SUB_79);
	...
	RzILOpPure *op_MUL_83 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_LSHIFT_89 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), SHIFTL0(VARLP("const_pos0x0ffffffffLL"), op_MUL_88));
	RzILOpPure *op_NOT_90 = LOGNOT(op_LSHIFT_89);
	RzILOpPure *op_AND_91 = LOGAND(VARG(Rdd_assoc_tmp), op_NOT_90);
	RzILOpPure *op_NE_92 = LET("const_pos32", DUP(const_pos32), LET("const_pos0", DUP(const_pos0), INV(EQ(VARLP("const_pos32"), VARLP("const_pos0")))));
	RzILOpPure *op_MUL_93 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	...
	RzILOpPure *op_MUL_98 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_99 = SHIFTR0(DUP(Rtt), op_MUL_98);
	RzILOpPure *op_AND_100 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_99, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *cond_107 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_92, VARL("h_tmp5"), VARLP("const_pos0LL")));
	...
	RzILOpPure *op_AND_110 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_109, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_MUL_113 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_114 = SHIFTR0(DUP(Rtt), op_MUL_113);
	RzILOpPure *op_AND_115 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_114, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_MUL_150 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_151 = SHIFTR0(DUP(Rss), op_MUL_150);
	RzILOpPure *op_AND_152 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_151, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *cast_st32_153 = CAST(32, MSB(op_AND_152), op_AND_152);
	RzILOpPure *cast_st64_154 = CAST(32, IL_FALSE, cast_st32_153);
	RzILOpPure *op_MUL_155 = LET("const_pos0", DUP(const_pos0), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos0"), VARLP("const_pos32"))));
	RzILOpPure *op_RSHIFT_156 = SHIFTR0(DUP(Rtt), op_MUL_155);
	RzILOpPure *op_AND_157 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(op_RSHIFT_156, VARLP("const_pos0x0ffffffffLL")));
	...
	RzILOpPure *op_LT_161 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_160, VARLP("const_pos0")));
	RzILOpPure *op_SUB_162 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_163 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_162));
	RzILOpPure *op_NEG_164 = NEG(op_LSHIFT_163);
	RzILOpPure *op_SUB_165 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_166 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_165));
	RzILOpPure *op_SUB_167 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_166, VARLP("const_pos1")));
	RzILOpPure *cond_168 = ITE(op_LT_161, op_NEG_164, op_SUB_167);
	RzILOpPure *cond_169 = ITE(op_EQ_119, op_SUB_130, cond_168);
	RzILOpPure *op_AND_170 = LET("const_pos0x0ffffffffLL", DUP(const_pos0x0ffffffffLL), LOGAND(cond_169, VARLP("const_pos0x0ffffffffLL")));
	RzILOpPure *op_MUL_171 = LET("const_pos1", DUP(const_pos1), LET("const_pos32", DUP(const_pos32), MUL(VARLP("const_pos1"), VARLP("const_pos32"))));
	RzILOpPure *op_LSHIFT_172 = SHIFTL0(op_AND_170, op_MUL_171);
	RzILOpPure *op_OR_173 = LOGOR(op_AND_91, op_LSHIFT_172);

	// WRITE
	RzILOpEffect *c_call_16 = HEX_SEXTRACT64(op_ADD_15, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_104 = HEX_SEXTRACT64(op_SUB_103, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	...
	RzILOpEffect *c_call_143 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp7"), VARL("h_tmp8"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s4_vxsubaddh(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_65 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_64, VARLP("const_pos0")));
	RzILOpPure *op_SUB_66 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_67 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_66));
	RzILOpPure *op_NEG_68 = NEG(op_LSHIFT_67);
	RzILOpPure *op_SUB_69 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_LT_146 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_145, VARLP("const_pos0")));
	RzILOpPure *op_SUB_147 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_148 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_147));
	RzILOpPure *op_NEG_149 = NEG(op_LSHIFT_148);
	RzILOpPure *op_SUB_150 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_LT_227 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_226, VARLP("const_pos0")));
	RzILOpPure *op_SUB_228 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_229 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_228));
	RzILOpPure *op_NEG_230 = NEG(op_LSHIFT_229);
	RzILOpPure *op_SUB_231 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_LT_308 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_307, VARLP("const_pos0")));
	RzILOpPure *op_SUB_309 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_310 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_309));
	RzILOpPure *op_NEG_311 = NEG(op_LSHIFT_310);
	RzILOpPure *op_SUB_312 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	...
	// WRITE
	RzILOpEffect *c_call_14 = HEX_SEXTRACT64(op_SUB_13, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_15 = SETL("h_tmp0", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_16 = SEQN(2, c_call_14, op_ASSIGN_hybrid_tmp_15);
	RzILOpEffect *c_call_37 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_38 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_79 = SETG(Rdd_assoc_tmp, op_OR_78);
	RzILOpEffect *empty_80 = EMPTY();
	RzILOpEffect *c_call_95 = HEX_SEXTRACT64(op_ADD_94, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_96 = SETL("h_tmp5", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_97 = SEQN(2, c_call_95, op_ASSIGN_hybrid_tmp_96);
	RzILOpEffect *c_call_118 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_119 = SETL("h_tmp6", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_160 = SETG(Rdd_assoc_tmp, op_OR_159);
	RzILOpEffect *empty_161 = EMPTY();
	RzILOpEffect *c_call_176 = HEX_SEXTRACT64(op_SUB_175, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_177 = SETL("h_tmp10", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_178 = SEQN(2, c_call_176, op_ASSIGN_hybrid_tmp_177);
	RzILOpEffect *c_call_199 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_200 = SETL("h_tmp11", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_241 = SETG(Rdd_assoc_tmp, op_OR_240);
	RzILOpEffect *empty_242 = EMPTY();
	RzILOpEffect *c_call_257 = HEX_SEXTRACT64(op_ADD_256, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos16", DUP(const_pos16), VARLP("const_pos16")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_258 = SETL("h_tmp15", SIGNED(16, VARL("ret_val")));
	RzILOpEffect *seq_259 = SEQN(2, c_call_257, op_ASSIGN_hybrid_tmp_258);
	RzILOpEffect *c_call_280 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_281 = SETL("h_tmp16", UNSIGNED(32, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_s4_vxsubaddhr(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cast_st16_12 = CAST(16, MSB(op_AND_11), op_AND_11);
	RzILOpPure *op_SUB_13 = SUB(cast_st16_8, cast_st16_12);
	RzILOpPure *op_ADD_14 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_13, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_15 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_14, VARLP("const_pos1")));
	RzILOpPure *cond_19 = LET("const_pos0LL", const_pos0LL, ITE(op_NE_4, VARL("h_tmp0"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_20 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_21 = SHIFTR0(DUP(Rss), op_MUL_20);
	...
	RzILOpPure *op_ADD_29 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_28, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_30 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_29, VARLP("const_pos1")));
	RzILOpPure *op_EQ_31 = EQ(cond_19, op_RSHIFT_30);
	RzILOpPure *op_MUL_32 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_33 = SHIFTR0(DUP(Rss), op_MUL_32);
	...
	RzILOpPure *op_ADD_41 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_40, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_42 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_41, VARLP("const_pos1")));
	RzILOpPure *cond_59 = ITE(VARL("h_tmp1"), VARL("h_tmp4"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_62 = LET("const_pos0", DUP(const_pos0), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos0"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_63 = SHIFTR0(DUP(Rss), op_MUL_62);
	...
	RzILOpPure *op_ADD_71 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_70, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_72 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_71, VARLP("const_pos1")));
	RzILOpPure *op_LT_73 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_72, VARLP("const_pos0")));
	RzILOpPure *op_SUB_74 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_75 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_74));
	...
	RzILOpPure *op_ADD_103 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_102, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_104 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_103, VARLP("const_pos1")));
	RzILOpPure *cond_108 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_93, VARL("h_tmp5"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_109 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_110 = SHIFTR0(DUP(Rss), op_MUL_109);
	...
	RzILOpPure *cast_st16_116 = CAST(16, MSB(op_AND_115), op_AND_115);
	RzILOpPure *op_ADD_117 = ADD(cast_st16_112, cast_st16_116);
	RzILOpPure *op_ADD_118 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_117, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_119 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_118, VARLP("const_pos1")));
	RzILOpPure *op_EQ_120 = EQ(cond_108, op_RSHIFT_119);
	RzILOpPure *op_MUL_121 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_122 = SHIFTR0(DUP(Rss), op_MUL_121);
	...
	RzILOpPure *op_ADD_130 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_129, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_131 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_130, VARLP("const_pos1")));
	RzILOpPure *cond_148 = ITE(VARL("h_tmp6"), VARL("h_tmp9"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_151 = LET("const_pos1", DUP(const_pos1), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos1"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_152 = SHIFTR0(DUP(Rss), op_MUL_151);
	...
	RzILOpPure *op_ADD_160 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_159, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_161 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_160, VARLP("const_pos1")));
	RzILOpPure *op_LT_162 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_161, VARLP("const_pos0")));
	RzILOpPure *op_SUB_163 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_164 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_163));
	...
	RzILOpPure *op_ADD_192 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_191, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_193 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_192, VARLP("const_pos1")));
	RzILOpPure *cond_197 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_182, VARL("h_tmp10"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_198 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_199 = SHIFTR0(DUP(Rss), op_MUL_198);
	...
	RzILOpPure *op_ADD_207 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_206, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_208 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_207, VARLP("const_pos1")));
	RzILOpPure *op_EQ_209 = EQ(cond_197, op_RSHIFT_208);
	RzILOpPure *op_MUL_210 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_211 = SHIFTR0(DUP(Rss), op_MUL_210);
	...
	RzILOpPure *op_ADD_219 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_218, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_220 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_219, VARLP("const_pos1")));
	RzILOpPure *cond_237 = ITE(VARL("h_tmp11"), VARL("h_tmp14"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_240 = LET("const_pos2", DUP(const_pos2), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos2"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_241 = SHIFTR0(DUP(Rss), op_MUL_240);
	...
	RzILOpPure *op_ADD_249 = LET("const_pos1", DUP(const_pos1), ADD(op_SUB_248, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_250 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_249, VARLP("const_pos1")));
	RzILOpPure *op_LT_251 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_250, VARLP("const_pos0")));
	RzILOpPure *op_SUB_252 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_253 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_252));
	...
	RzILOpPure *op_ADD_281 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_280, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_282 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_281, VARLP("const_pos1")));
	RzILOpPure *cond_286 = LET("const_pos0LL", DUP(const_pos0LL), ITE(op_NE_271, VARL("h_tmp15"), VARLP("const_pos0LL")));
	RzILOpPure *op_MUL_287 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_288 = SHIFTR0(DUP(Rss), op_MUL_287);
	...
	RzILOpPure *op_ADD_296 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_295, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_297 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_296, VARLP("const_pos1")));
	RzILOpPure *op_EQ_298 = EQ(cond_286, op_RSHIFT_297);
	RzILOpPure *op_MUL_299 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_300 = SHIFTR0(DUP(Rss), op_MUL_299);
	...
	RzILOpPure *cast_st16_306 = CAST(16, MSB(op_AND_305), op_AND_305);
	RzILOpPure *op_ADD_307 = ADD(cast_st16_302, cast_st16_306);
	RzILOpPure *op_ADD_308 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_307, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_309 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_308, VARLP("const_pos1")));
	RzILOpPure *cond_326 = ITE(VARL("h_tmp16"), VARL("h_tmp19"), VARG(usr_assoc_tmp));
	RzILOpPure *op_MUL_329 = LET("const_pos3", DUP(const_pos3), LET("const_pos16", DUP(const_pos16), MUL(VARLP("const_pos3"), VARLP("const_pos16"))));
	RzILOpPure *op_RSHIFT_330 = SHIFTR0(DUP(Rss), op_MUL_329);
	...
	RzILOpPure *op_ADD_338 = LET("const_pos1", DUP(const_pos1), ADD(op_ADD_337, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_339 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_338, VARLP("const_pos1")));
	RzILOpPure *op_LT_340 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_339, VARLP("const_pos0")));
	RzILOpPure *op_SUB_341 = LET("const_pos16", DUP(const_pos16), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos16"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_342 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_341));
...
RzILOpEffect *hex_il_op_s4_vxsubaddw(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_LT_73 = LET("const_pos0", DUP(const_pos0), ULT(op_SUB_72, VARLP("const_pos0")));
	RzILOpPure *op_SUB_74 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_75 = LET("const_pos1LL", const_pos1LL, SHIFTL0(VARLP("const_pos1LL"), op_SUB_74));
	RzILOpPure *op_NEG_76 = NEG(op_LSHIFT_75);
	RzILOpPure *op_SUB_77 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	RzILOpPure *op_LT_161 = LET("const_pos0", DUP(const_pos0), ULT(op_ADD_160, VARLP("const_pos0")));
	RzILOpPure *op_SUB_162 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	RzILOpPure *op_LSHIFT_163 = LET("const_pos1LL", DUP(const_pos1LL), SHIFTL0(VARLP("const_pos1LL"), op_SUB_162));
	RzILOpPure *op_NEG_164 = NEG(op_LSHIFT_163);
	RzILOpPure *op_SUB_165 = LET("const_pos32", DUP(const_pos32), LET("const_pos1", DUP(const_pos1), SUB(VARLP("const_pos32"), VARLP("const_pos1"))));
	...
	// WRITE
	RzILOpEffect *c_call_16 = HEX_SEXTRACT64(op_SUB_15, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_17 = SETL("h_tmp0", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_18 = SEQN(2, c_call_16, op_ASSIGN_hybrid_tmp_17);
	RzILOpEffect *c_call_43 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_44 = SETL("h_tmp1", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_86 = SETG(Rdd_assoc_tmp, op_OR_85);
	RzILOpEffect *empty_87 = EMPTY();
	RzILOpEffect *c_call_104 = HEX_SEXTRACT64(op_ADD_103, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos32", DUP(const_pos32), VARLP("const_pos32")));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_105 = SETL("h_tmp5", SIGNED(64, VARL("ret_val")));
	RzILOpEffect *seq_106 = SEQN(2, c_call_104, op_ASSIGN_hybrid_tmp_105);
	RzILOpEffect *c_call_131 = HEX_REGFIELD(HEX_RF_WIDTH, HEX_REG_FIELD_USR_OVF);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_132 = SETL("h_tmp6", UNSIGNED(32, VARL("ret_val")));
