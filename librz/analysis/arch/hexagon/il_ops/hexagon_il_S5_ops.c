...
RzILOpEffect *hex_il_op_s5_asrhub_rnd_sat_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 i;
...
RzILOpEffect *hex_il_op_s5_asrhub_sat_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 i;
	RzILOpPure *const_pos0 = UN(32, 0x0);
	RzILOpPure *const_pos4 = UN(32, 0x4);
...
RzILOpEffect *hex_il_op_s5_popcountp_part0(HexInsnPktBundle *bundle) {
	NOT_IMPLEMENTED;
	const HexInsn *hi = bundle->insn;
	NOT_IMPLEMENTED;
}

RzILOpEffect *hex_il_op_s5_vasrhrnd_part0(HexInsnPktBundle *bundle) {
	// READ
	// Declare: ut32 i;
	RzILOpPure *const_pos0 = UN(32, 0x0);
	RzILOpPure *const_pos4 = UN(32, 0x4);
