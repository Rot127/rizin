...
RzILOpEffect *hex_il_op_s5_asrhub_rnd_sat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *cond_31 = ITE(op_NE_13, VARL("h_tmp2269"), cast_32);
	...
	RzILOpPure *cast_49 = LET("const_pos0xffff", DUP(const_pos0xffff), CAST(64, MSB(DUP(VARLP("const_pos0xffff"))), VARLP("const_pos0xffff")));
	...
	RzILOpPure *arg_cast_66 = CAST(64, MSB(DUP(VARL("h_tmp2271"))), VARL("h_tmp2271"));
	RzILOpPure *arg_cast_67 = CAST(64, MSB(DUP(VARL("h_tmp2272"))), VARL("h_tmp2272"));
	...
	RzILOpPure *cond_72 = ITE(NON_ZERO(VARL("h_tmp2270")), VARL("h_tmp2273"), cast_73);
	...
	RzILOpPure *cast_103 = CAST(32, MSB(DUP(op_OR_100)), op_OR_100);

	// WRITE
	RzILOpEffect *op_ASSIGN_0 = SETL("i", cast_1);
	RzILOpEffect *op_INC_4 = SETL("i", INC(VARL("i"), 32));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_5 = SETL("h_tmp2268", VARL("i"));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_29 = SETL("h_tmp2269", UNSIGNED(64, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_56 = SETL("h_tmp2270", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_59 = SETL("h_tmp2271", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_62 = SETL("h_tmp2272", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_69 = SETL("h_tmp2273", UNSIGNED(64, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_s5_asrhub_sat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *const_pos0LL = SN(64, 0x0);
	const char *usr_assoc_tmp = ALIAS2REG(HEX_REG_ALIAS_USR, true);
	// Declare: ut32 h_tmp2276;
	// Declare: ut32 h_tmp2277;
	// Declare: ut32 h_tmp2278;
	RzILOpPure *const_pos1 = UN(32, 0x1);
	// Declare: ut64 h_tmp2279;
	RzILOpPure *const_pos1LL = SN(64, 0x1);
	...
	RzILOpPure *cond_28 = ITE(op_NE_13, VARL("h_tmp2275"), cast_29);
	...
	RzILOpPure *arg_cast_57 = CAST(64, MSB(DUP(VARL("h_tmp2277"))), VARL("h_tmp2277"));
	RzILOpPure *arg_cast_58 = CAST(64, MSB(DUP(VARL("h_tmp2278"))), VARL("h_tmp2278"));
	...
	RzILOpPure *cond_63 = ITE(NON_ZERO(VARL("h_tmp2276")), VARL("h_tmp2279"), cast_64);
	...
	RzILOpPure *cast_92 = CAST(32, MSB(DUP(op_OR_89)), op_OR_89);

	// WRITE
	RzILOpEffect *op_ASSIGN_0 = SETL("i", cast_1);
	RzILOpEffect *op_INC_4 = SETL("i", INC(VARL("i"), 32));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_5 = SETL("h_tmp2274", VARL("i"));
	RzILOpEffect *seq_6 = SEQN(2, op_ASSIGN_hybrid_tmp_5, op_INC_4);
	RzILOpEffect *imm_assign_20 = SETL("u", u);
	RzILOpEffect *c_call_22 = HEX_EXTRACT64(arg_cast_23, arg_cast_24, arg_cast_25);
	RzILOpEffect *op_ASSIGN_hybrid_tmp_26 = SETL("h_tmp2275", UNSIGNED(64, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_47 = SETL("h_tmp2276", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_50 = SETL("h_tmp2277", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_53 = SETL("h_tmp2278", UNSIGNED(32, VARL("ret_val")));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_60 = SETL("h_tmp2279", UNSIGNED(64, VARL("ret_val")));
...
RzILOpEffect *hex_il_op_s5_vasrhrnd(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_ADD_20 = LET("const_pos1", const_pos1, ADD(cast_21, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_22 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_20, VARLP("const_pos1")));
	RzILOpPure *op_AND_23 = LET("const_pos0x0ffff", const_pos0x0ffff, LOGAND(op_RSHIFT_22, VARLP("const_pos0x0ffff")));
	...
	RzILOpPure *op_LSHIFT_27 = SHIFTL0(cast_ut64_24, op_MUL_25);
	RzILOpPure *cast_29 = CAST(64, IL_FALSE, op_AND_11);
	...
	RzILOpEffect *op_ASSIGN_0 = SETL("i", cast_1);
	RzILOpEffect *op_INC_4 = SETL("i", INC(VARL("i"), 32));
	RzILOpEffect *op_ASSIGN_hybrid_tmp_5 = SETL("h_tmp2280", VARL("i"));
	RzILOpEffect *seq_6 = SEQN(2, op_ASSIGN_hybrid_tmp_5, op_INC_4);
	...
	RzILOpEffect *seq_33 = SEQN(2, op_ASSIGN_30, empty_32);
	RzILOpEffect *seq_34 = SEQN(2, seq_6, seq_33);
	RzILOpEffect *for_36 = REPEAT(op_LT_2, seq_34);
	RzILOpEffect *seq_35 = SEQN(2, op_ASSIGN_0, for_36);
	RzILOpEffect *instruction_sequence = SEQN(2, imm_assign_18, seq_35);
