...
RzILOpEffect *hex_il_op_s5_asrhub_rnd_sat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_17 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_16, VARLP("const_pos1")));
	...
	RzILOpPure *op_ADD_28 = LET("const_pos1", DUP(const_pos1), ADD(op_RSHIFT_27, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_29 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_28, VARLP("const_pos1")));
	...
	RzILOpPure *op_ADD_36 = LET("const_pos1", DUP(const_pos1), ADD(op_RSHIFT_35, VARLP("const_pos1")));
	...
	RzILOpPure *op_ADD_62 = LET("const_pos1", DUP(const_pos1), ADD(op_RSHIFT_61, VARLP("const_pos1")));
	RzILOpPure *op_RSHIFT_63 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_62, VARLP("const_pos1")));
	RzILOpPure *op_LT_64 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_63, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_65 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", DUP(const_pos8), SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	RzILOpPure *op_SUB_66 = LET("const_pos1", DUP(const_pos1), SUB(op_LSHIFT_65, VARLP("const_pos1")));
	RzILOpPure *cond_67 = LET("const_pos0", DUP(const_pos0), ITE(op_LT_64, VARLP("const_pos0"), op_SUB_66));
	RzILOpPure *cond_68 = ITE(op_EQ_30, op_RSHIFT_37, cond_67);
	RzILOpPure *op_AND_69 = LET("const_pos0x0ffLL", DUP(const_pos0x0ffLL), LOGAND(cond_68, VARLP("const_pos0x0ffLL")));
	RzILOpPure *cast_ut64_70 = CAST(64, IL_FALSE, op_AND_69);
	RzILOpPure *op_MUL_71 = LET("const_pos8", DUP(const_pos8), MUL(VARL("i"), VARLP("const_pos8")));
	...
	RzILOpEffect *c_call_18 = HEX_EXTRACT64(op_RSHIFT_17, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos8", DUP(const_pos8), VARLP("const_pos8")));
	...
	RzILOpEffect *c_call_50 = HEX_DEPOSIT64(VARG(usr_assoc_tmp), VARL("h_tmp3"), VARL("h_tmp4"), LET("const_pos1", DUP(const_pos1), VARLP("const_pos1")));
...
RzILOpEffect *hex_il_op_s5_asrhub_sat(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_MUL_51 = LET("const_pos16", DUP(const_pos16), MUL(VARL("i"), VARLP("const_pos16")));
	...
	RzILOpPure *op_LT_56 = LET("const_pos0", DUP(const_pos0), ULT(op_RSHIFT_55, VARLP("const_pos0")));
	RzILOpPure *op_LSHIFT_57 = LET("const_pos1LL", const_pos1LL, LET("const_pos8", DUP(const_pos8), SHIFTL0(VARLP("const_pos1LL"), VARLP("const_pos8"))));
	...
	RzILOpEffect *op_ASSIGN_hybrid_tmp_4 = SETL("h_tmp0", VARL("i"));
	RzILOpEffect *seq_5 = SEQN(2, op_ASSIGN_hybrid_tmp_4, op_INC_3);
	RzILOpEffect *c_call_16 = HEX_EXTRACT64(op_RSHIFT_15, LET("const_pos0", DUP(const_pos0), VARLP("const_pos0")), LET("const_pos8", DUP(const_pos8), VARLP("const_pos8")));
...
RzILOpEffect *hex_il_op_s5_vasrhrnd(HexInsnPktBundle *bundle) {
	...
	RzILOpPure *op_RSHIFT_16 = LET("const_pos1", DUP(const_pos1), SHIFTR0(op_ADD_15, VARLP("const_pos1")));
