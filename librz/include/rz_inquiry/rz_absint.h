...
/**
 * \file
 * \brief RzIL-based abstract interpretation and analysis based on it
 */
...
typedef enum rz_absint_trace_options_t {
	...
	RZ_ABSINT_TRACE_EVAL_BLOCK = (1 << 1), ///< e inquiry.trace=evalblock; log coarse information about absint blocks as they are evaluated
